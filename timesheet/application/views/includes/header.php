...
<head>
	...
	<title>Timesheet - <?php if (isset($title)) {echo $title;} ?></title>
	...
	<script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>js/jquery.thooClock.js"></script>
...
#dropdown-right .dropdown-menu{left:0%;z-index:222222222222;}
            		...
            		<div class="header-top">
		                ...
		                <div class="header-top-left" style="float: right;margin-right: 7px;">
		                	<h3 style="margin-top: 7px;text-align: right;margin-bottom: 0px;"><span class="username"><?php  echo $user->username; ?> </span></h3>
		               		<h5 class="app-name">Time Sheet System</h5>
		                </div>
    			...
    			<div class="" align="center">
    				<nav class="navbar navbar-default header-bottom">
			    		...
			    		<div class="main-menu responsive-menu collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			                <ul class="nav">
				                <li class=<?php  if($this->uri->segment(1)=="overview" || $this->uri->segment(1) == '') echo "active" ?>><?php echo anchor('overview', 'Overview',array('class'=>'overview')); ?></li>
								<?php //task #4124
								if($user_app_role != 'admin'):
								?>
								<li class=<?php  if($this->uri->segment(1)=="weekly-timesheet") echo "active" ?>><?php echo anchor('weekly-timesheet','Time Sheet',array('class'=>'project_list')); ?></li>
								<?php endif; ?>
								
								<?php //task #4124
								if($user_app_role != 'admin'):
								?>
								<li class=<?php  if($this->uri->segment(1)=="view-timesheets") echo "active" ?>><?php echo anchor('view-timesheets','View Time Sheets',array('class'=>'company_list')); ?></li>
								<?php endif; ?>
								
								<?php if($user_app_role == 'manager' || $user_app_role == 'admin'): ?>
								<li id="dropdown-right" class="dropdown<?php  if($this->uri->segment(1)=="staff-timesheets") echo " active" ?>">
									<a class="dropdown-toggle" data-toggle="dropdown" href="staff-timesheets">Managers Area<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li>
											<?php echo anchor('staff-timesheets','Staff Time Sheets',array('class'=>'staff-timesheets')); ?>
										</li>
										<li>
											<?php echo anchor('timesheet/project_hours','Project Hours',array('class'=>'project_hours')); ?>
										</li>
										<li>
											<?php echo anchor('timesheet/revert_submit','Revert Submits',array('class'=>'project_hours')); ?>
										</li>
									</ul>
								</li>
								<?php endif; ?>
