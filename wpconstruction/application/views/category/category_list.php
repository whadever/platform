		...
		<div class="row"> 
			<div class="col-xs-12 col-sm-6 col-md-6">
            	<div class="contactsearchbox">
					<input type="text" id="search_category" class="search_contact form-control" name="search" placeholder="Search" /><!--Advance Search-->
				</div>
     		</div>
			<div class="col-xs-12 col-sm-6 col-md-6">
...
<div class="modal fade" id="AddCategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  	<div class="modal-dialog">
    	<div class="modal-content">
			...
			$category_name = form_label('Company Name (*)', 'contact_title');
					...
					<table class="contact">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php if($category->status == 1){ echo "ACTIVE";}else{echo "INACTIVE";} ?><a href="<?php echo base_url(); ?>category/category_update/<?php echo $category->id; ?>"><img class="edit_icon" src="<?php echo base_url(); ?>images/icon/icon_edit.png" /></a></td>
							</tr>
							<?php	} ?>	
						</tbody>
					</table>
