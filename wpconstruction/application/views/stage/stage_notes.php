...
<div id="development-notes">
    ...
    <div id="devlopment-notes-search" class="notes-box" style="text-align: center">
        ...
        <form method="post" action="<?php echo base_url().'stage/search_stage_notes/'.$note_development_id.'/'.$stage_id ;?>">
    ...
    <div id="note-message-dialog-box" title="">    
        ...
        <form id="addmessageform" action="<?php echo base_url();?>stage/send_stage_note_message/<?php echo $note_development_id;?>" method="post">
    ...
    <div id="add-note-dialog-box" title="">
        ...
        <form id="addnoteform" action="<?php echo base_url().'stage/save_stage_note/'.$note_development_id.'/'.$stage_id;?>" method="post">
...
<script>
    function loadNotes(note_id){
        ...
        $.ajax({  
                url: "<?php print base_url(); ?>stage/stage_notes_details/"+note_id,  
                dataType: 'html',  
                type: 'GET',  
