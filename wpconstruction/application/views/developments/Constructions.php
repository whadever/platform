...
class Constructions extends CI_Controller {
    ...
    public function save_development_photo($pid = 0) {
        ...
        $photo_info = array(
            ...
            'photo_permission' => $this->input->post('photo_permission')
        );
    ...
    public function construction_overview_all_jobs() {
        ...
        $this->db->select("development_name, id, parent_unit");
    ...
    public function tendering($jid){
        ...
        $this->db->select(
            "item.id item_id,
             ...
             DATE_FORMAT(t_jobs.date_received, '%d-%m-%Y') date_received,
    ...
    public function send_tender($email, $fid, $items){
        ...
        $message .= "</ul>";
        $message .= "Please contact Blair Chappell - blair@williamscorporation.co.nz - 027  205 3118.<br><br>";
                ...
                if($fid){
                    ...
                    foreach($info as $inf){
                        ...
                        if($row){
                            ...
                            $this->db->update('construction_tendering_jobs', array(
    ...
    public function update_tendering_status(){
        ...
        $this->db->where('id',$construction_template_task_id);
        $this->db->update('construction_template_task',array('task_person_responsible' => $contact_id));
    ...
    public function update_list($development_id,$field,$value){
		...
		for($i=0;$i < count($contact_ids); $i++){
			...
			if($uid){
            	...
            	$this->db->insert('construction_user_job', $insert_data); 
			}
