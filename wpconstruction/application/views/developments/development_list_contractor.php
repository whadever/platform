...
jQuery(document).ready(function() {
	...
	$("#development-name").keyup(function() {
		...
		$.ajax({
			url: window.Url + 'developments/change_development_status_contractor/' + selectedStatusId + '/' + selectedLocationId + '/' + selectedDevelopmentName,
			type: 'GET',
					...
					<div class="dev-main-body">
						<div class="dev-main-search">
							<form action="#" method="post">
								...
								<input type="text" id="development-name" name="development_name" value="<?php if(isset($get['development_name'])){ echo $get['development_name']; } ?>" placeholder="Development Name" />
