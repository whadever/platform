...
<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					...
					<input type="text" name="agreed_funding_facility" value="<?php if($investor_data->agreed_funding_facility){ echo '$'.number_format($investor_data->agreed_funding_facility);} ?>" <?php if($app_role_id == 5){ ?> readonly <?php } ?> class="form-control" placeholder="Numeric value with $ as a fix one"  >
					<?php if($app_role_id != 5){ ?> <img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"> <?php } ?>
				</div>
			</div>

			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
					Estimation Settlement Date
					<input type="text" value="<?php if($investor_data->estimation_settlement_date!='0000-00-00' && $investor_data->estimation_settlement_date !=''){ echo date("d-m-Y", strtotime($investor_data->estimation_settlement_date)); } ?>" <?php if($app_role_id == 5){ ?> readonly <?php } ?>  class="form-control <?php if($app_role_id != 5){ ?>  jq_datepicker <?php } ?>" name="estimation_settlement_date" placeholder="">
					<?php if($app_role_id != 5){ ?> <img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
					Interest Rate %
					<input type="text" value="<?php if($investor_data->interest_rate){ echo $investor_data->interest_rate;} ?>" <?php if($app_role_id == 5){ ?> readonly <?php } ?> class="form-control" placeholder="" name="interest_rate">
					<?php if($app_role_id != 5){ ?> <img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
				</div>
			</div>
			...
			<div id="draw_down" class="row">
				...
				?>
					...
					<div class="draw_down_box">
						<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
							<input type="text" name="draw_date" value="<?php echo date("d-m-Y", strtotime($draw->draw_date));?>" <?php if($app_role_id == 5){ ?> readonly <?php } ?> onchange="update_draw_amount(this)" class="form-control <?php if($app_role_id != 5){ ?> jq_datepicker <?php } ?>" placeholder="">
							<?php if($app_role_id != 5){ ?><img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-5 col-lg-5 col-xl-5">
							<input type="text" name="draw_down_amount" value="<?php echo "$".number_format($draw->draw_down_amount); ?>" <?php if($app_role_id == 5){ ?> readonly <?php } ?> onblur="update_draw_amount(this)" class="form-control draw" placeholder=""> 
							<?php if($app_role_id != 5){ ?><img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
						</div> 
		 				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
							<?php if($app_role_id != 5){ ?><span id="delete_draw_down" onclick="delete_row(this)" style="font-size:30px">x</span> <?php } ?>
						</div> 
				...
				<?php } ?>
					...
					<div class="draw_down_box">
						<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
							<input type="text" name="draw_date" value="" onchange="update_draw_amount(this)" <?php if($app_role_id == 5){ ?> readonly <?php } ?>  class="form-control <?php if($app_role_id != 5){ ?>  jq_datepicker <?php } ?>" placeholder="">
							<?php if($app_role_id != 5){ ?><img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
						</div>
						<div class="col-xs-10 col-sm-10 col-md-5 col-lg-5 col-xl-5">
							<input type="text" name="draw_down_amount" value="" onblur="update_draw_amount(this)" <?php if($app_role_id == 5){ ?> readonly <?php } ?>  class="form-control draw" placeholder=""> 
							<?php if($app_role_id != 5){ ?><img src="<?php echo base_url(); ?>images/ajax-saving.gif" class="loading"><?php } ?>
						</div> 
		 				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
							<?php if($app_role_id != 5){ ?><span class="add_draw_down" style="font-size:30px">+</span><?php } ?>
						</div> 
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
					<textarea class="form-control" placeholder="New Sales Plan" readonly ><?php echo $development_details->new_sales_plan ?></textarea>	
				</div>
...
<div class="task-phase-add">
	<?php if($this->uri->segment(2) != 'construction_overview_all'):?>
				...
				success:function(data){
					if(data){
						...
						$('#draw_down .draw_down_box').each(function(){
								...
								var predicted_interest_earned = ((draw_amount * interest_rate)/(100 * 365)) * days; 
								var current_interest_earned =  ((draw_amount * interest_rate)/(100 * 365)) * curr_days;
