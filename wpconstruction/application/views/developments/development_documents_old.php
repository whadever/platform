...
<div id="development-notes">
        ...
        <div>
        	<ul>
        		<li style="border-bottom: 1px solid;">
        			<a class="<?php if(isset($category_id)){if($category_id==1) echo 'link_active'; else echo 'link_normal';}else echo 'link_active'; ?>" href="<?php echo base_url().'developments/development_documents_bycategory/'.$development_id; ?>/1" >Financial</a>  
        		</li>
        		<li style="border-bottom: 1px solid;">
        			<a class="<?php if(isset($category_id)){if($category_id==2) echo 'link_active'; else echo 'link_normal';}else echo 'link_normal'; ?>" href="<?php echo base_url().'developments/development_documents_bycategory/'.$development_id; ?>/2" >Land</a> 
        		</li>
        	</ul>
        </div>
  ...
  download the PDF file.</a></p>
    ...
    <div id="stage-button" class="notes-box" style="text-align: center; width:10%;">
		...
		<button title="Delete This Document" class="btn-photo delete-document" id="btnSaveDocument" type="button" name="savedocument">			
...
<div id="delete-document-modal">
	...
	<div class="modal-footer">
		<form action="<?php echo base_url();?>developments/development_document_delete" method="post">
    ...
    <div id="add-note-dialog-box" title="">
		...
		<div class="doc_add_title" style="text-align:center; margin:0px 0px 20px 0px"><h4>Add Development Document</h4></div>
...
$dropdown_js = 'class="form-control" style="width:50%"';
    	...
    	$action =  base_url().'developments/save_development_document/'.$development_id;
...
<script>
    function loadNotes(document_id){
        ...
        $.ajax({  
                url: "<?php print base_url(); ?>developments/development_document_detail/"+document_id,  
                dataType: 'html',  
                type: 'GET',  
