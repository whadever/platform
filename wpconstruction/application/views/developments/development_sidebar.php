...
<div class="sidebar"> 
    <div class="block">   
        ...
        <ul class="sidebar-nav">
              <li id="0" class="active "><?php echo anchor(base_url().'developments/development_detail/'.$development_id,'Development',array('class'=>'stage')); ?>
...
?>
              <li id="menu-<?php echo $i; ?>"><?php echo anchor( base_url().'stage/stage_info/'.$development_id.'/'.$i,'Stage '.$i, array('class'=>$stage)); ?><?php echo $image; ?>
