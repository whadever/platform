...
class Notes_model extends CI_Model {
	...
	function getPriviousNotes($rid){
        ...
        function insertNote($rid, $note, $uid){      
        ...
        function get_request_detail($id){
             ...
             $this->db->select('request.*, project.project_name, a.name as manager_name, b.name as developer_name, f.filename as document, f.filepath as document_path, i.filename as image, i.filepath as image_path');  
