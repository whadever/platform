...
<div class="header">
    <div class="container">
        ...
        <div class="header-top-right" style="">
            ...
            <a id="logout" <?php if($user_role_id!=1){ ?> onClick="if(($('#cmemory').val() == 1) && confirm('Are you sure you want to exit without saving your data?')){return true}
			else if(($('#cmemory').val() == '') && confirm('Are you sure you want to exit?')){return true}
			else {return false}" <?php } ?> href="<?php echo base_url();?>user/user_logout"> <img src="<?php echo base_url();?>images/btn_power.png" height="67" title="Logout" alt="Logout" /></a>
