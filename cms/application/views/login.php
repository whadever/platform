<style type="text/css">
html{	background-image: url(http://horncastledevelopments.co.nz/images/headerimage.jpg);background-position: center center; background-repeat: no-repeat; background-size: 100% 100%; height: 100%; }
...
<head>
	...
	<title>Consent Management System - Login - <?php if (isset($title)) {echo $title;} ?></title>
...
<?php
	...
	echo form_open('user/user_login', $form_attributes);
	 ...
	 echo '<div id="login-image">' . '<img width="150" src="' . base_url().'images/horncastle-arena.png" />'. '</div>';
