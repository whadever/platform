		...
		<?php
			...
			<tbody id="<?php echo $month_id; ?>" class="tbody<?php echo $p; ?> connectedSortable">
				...
				{ 
					...
					if($consent_info[$t]->contract_type=='BC' && $consent_info[$t]->design == '' ){
					...
					}elseif($consent_info[$t]->unconditional_date == '0000-00-00' or $consent_info[$t]->approval_date != '0000-00-00' or $consent_info[$t]->design =='Sign' ){
						$text_design = 'Sign';
						$bg_design = 'background-color:orange';
					}elseif(($consent_info[$t]->unconditional_date != '0000-00-00' && $consent_info[$t]->approval_date == '0000-00-00') or $consent_info[$t]->pricing_for_approval != '0000-00-00'){
						$text_design = 'Allo';
				...
				{ 
					...
					if($consent_info[$t]->approval_date == '0000-00-00' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						$text_design_approval_date = 'N/A';
						$bg_design_approval_date = '';
					}elseif($consent_info[$t]->approval_date != '0000-00-00'){
						$text_design_approval_date = $this->wbs_helper->to_report_date($consent_info[$t]->approval_date);
				...
				<?php if($nuser_permission_type[47]->display_type == 1){
						...
						if($consent_info[$t]->ok_to_release_to_marketing == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							...
							$bg_ok_to_release_to_marketing = '';
						}elseif($consent_info[$t]->approval_date != "0000-00-00" && $consent_info[$t]->ok_to_release_to_marketing == ''){
				...
				<?php if($nuser_permission_type[48]->display_type == 1){ 
					...
					if($consent_info[$t]->pricing_requested == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						...
						$bg_pricing_requested = '';
					}elseif($consent_info[$t]->approval_date!='0000-00-00' && $consent_info[$t]->contract_type == 'HL' && $consent_info[$t]->approval_date > $twenty_days_before && $consent_info[$t]->pricing_requested =='0000-00-00'){
				...
				<?php if($nuser_permission_type[49]->display_type == 1){ 
					...
					if($consent_info[$t]->pricing_for_approval == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						...
						$bg_pricing_for_approval = '';
					}elseif($consent_info[$t]->approval_date!='0000-00-00' && $consent_info[$t]->contract_type == 'HL' && $consent_info[$t]->pricing_requested =='0000-00-00' && $consent_info[$t]->pricing_for_approval=='0000-00-00' ){
				...
				<?php if($nuser_permission_type[52]->display_type == 1){
					...
					if($consent_info[$t]->kitchen_disign_requested == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){		
						...
						$bg_kitchen_disign_requested = '';
					}elseif( $consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date !='0000-00-00' && $twenty_days_before < $consent_info[$t]->approval_date){
				...
				<td class="close" id="9_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;">
					...
					if($consent_info[$t]->approval_date!='0000-00-00' && ( $consent_info[$t]->council == 'Chch' or $consent_info[$t]->council == 'Waimak' or $consent_info[$t]->council == 'Hurunui' or $consent_info[$t]->council == 'Ashburton')){
					...
					if($consent_info[$t]->approval_date!='0000-00-00' && ($consent_info[$t]->council == 'Auckland' or $consent_info[$t]->council == 'Waikato')){
				...
				?>
				<td class="close" id="33_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;color:white;<?php echo $bg_mss; ?>">
							...
							<tr id="consent_<?php echo $consent_info[$t]->month_id.'_'.$consent_child[$c]->id; ?>" class="child_<?php echo $consent_info[$t]->id; ?>" style="display:none;" onclick="selectrow(this.id,this.className);  ">
								...
								<?php } if($nuser_permission_type[1]->display_type == 1){ 
										...
										if($consent_child[$c]->contract_type=='BC'){
											$text_design = 'Allocate';
											$bg_design = 'background-color:#90ee90;color:black';
										}elseif($consent_child[$c]->unconditional_date != '0000-00-00' && $consent_child[$c]->approval_date != '0000-00-00'){
											$text_design = 'REQ Brief';
											$bg_design = 'background-color:yellow;color:black';
										}elseif($consent_child[$c]->unconditional_date == '0000-00-00' && $consent_child[$c]->approval_date != '0000-00-00'){
											$text_design = 'Sign';
								...
								<?php } if($nuser_permission_type[2]->display_type == 1){ 
									$bg_design_approval_date = '';
									if($consent_child[$c]->approval_date != '0000-00-00'){
										$bg_design_approval_date = 'background-color:#90ee90;color:black;';
									}
								?>
								<td id="2_col_<?php echo $consent_child[$c]->job_no; ?>"  class="child close" style="width:145px;height:45px;<?php echo $bg_design_approval_date; ?>">
									<?php if($consent_child[$c]->approval_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->approval_date); }  ?>
								</td>
								<?php } if($nuser_permission_type[47]->display_type == 1){ 
										$text_ok_to_release_to_marketing = '';
										$bg_ok_to_release_to_marketing = '';
								...
								<?php } if($nuser_permission_type[48]->display_type == 1){ 
										...
										if($consent_child[$c]->pricing_requested == '0000-00-00' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
											$text_pricing_requested = 'N/A';
											$bg_pricing_requested = '';
										}elseif($consent_child[$c]->approval_date!='0000-00-00' && $consent_child[$c]->contract_type == 'HL' && $consent_child[$c]->approval_date > $twenty_days_before && $consent_child[$c]->pricing_requested =='0000-00-00'){
											$text_pricing_requested = "REQ";
											$bg_pricing_requested = 'background-color:red;color:white;';
										...
										}elseif($consent_child[$c]->approval_date < $twenty_days_before && $consent_child[$c]->approval_date!='0000-00-00' && $consent_child[$c]->pricing_requested =='0000-00-00'){
											$text_pricing_requested = "OVERDUE";
											$bg_pricing_requested = 'background-color:red;color:white;';
								...
								<?php } if($nuser_permission_type[49]->display_type == 1){ 
									...
									if($consent_child[$c]->pricing_for_approval == '0000-00-00' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
										$text_pricing_for_approval = 'N/A';
										$bg_pricing_for_approval = '';
									}elseif($consent_child[$c]->approval_date!='0000-00-00' && $consent_child[$c]->contract_type == 'HL' && $consent_child[$c]->pricing_requested =='0000-00-00' && $consent_child[$c]->pricing_for_approval=='0000-00-00' ){
										$text_pricing_for_approval = "DUE";
										$bg_pricing_for_approval = "background-color:orange; color:black";
								...
								<?php } if($nuser_permission_type[52]->display_type == 1){ 
									...
									if($consent_child[$c]->kitchen_disign_requested == '' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){		
										$text_kitchen_disign_requested = 'N/A';						
										$bg_kitchen_disign_requested = '';
									}elseif( $consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $consent_child[$c]->pricing_for_approval !='0000-00-00' && $twenty_days_before < $consent_child[$c]->approval_date){
										$text_kitchen_disign_requested = "REQ";
										$bg_kitchen_disign_requested = "background-color:red;color:white;";
									...
									}elseif($twenty_days_before > $consent_child[$c]->approval_date && $consent_child[$c]->approval_date !='0000-00-00' ){
										$text_kitchen_disign_requested = "OVERDUE"; 
										$bg_kitchen_disign_requested = "background-color:red;color:white;";
								...
								<?php } if($nuser_permission_type[53]->display_type == 1){ 
									...
									if( $consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $consent_child[$c]->pricing_for_approval !='0000-00-00' && $consent_child[$c]->colours_requested_and_loaded_on_gc == '0000-00-00' && $twenty_days_before < $consent_child[$c]->approval_date){
										$text_colours_requested_and_loaded_on_gc = "REQ";
										$bg_colours_requested_and_loaded_on_gc = "background-color:red;color:white;";
								...
								<?php } if($nuser_permission_type[54]->display_type == 1){ 
									...
									$text_kitchen_design_loaded_on_gc = '';
									$bg_kitchen_design_loaded_on_gc = '';
									if($consent_child[$c]->kitchen_disign_requested == 'REQ' OR($consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $twenty_days_before < $consent_child[$c]->approval_date)){
										$text_kitchen_design_loaded_on_gc = "REQ";
										$bg_kitchen_design_loaded_on_gc = "background-color:red;color:white;";
									}else{
								...
								<td class="close" id="9_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									...
									if($consent_child[$c]->approval_date!='0000-00-00' && ( $consent_child[$c]->council == 'Chch' or $consent_child[$c]->council == 'Waimak' or $consent_child[$c]->council == 'Hurunui' or $consent_child[$c]->council == 'Ashburton')){
									...
									if($consent_child[$c]->approval_date!='0000-00-00' && ($consent_child[$c]->council == 'Auckland' or $consent_child[$c]->council == 'Waikato')){
