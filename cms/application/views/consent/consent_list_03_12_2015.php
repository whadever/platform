	...
	$('.consent_table tr td').dblclick(function(e){
		...
		if($("#"+tdid).hasClass("close")){
			...
			if(cons_indx == 0){
				...
				$("#"+tdid).append('<select name="pricing_requested" id="pricing_requested_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
			}else if(cons_indx == 49){
				$("#"+tdid).append('<select name="pricing_for_approval" id="pricing_for_approval_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
				...
				$("#"+tdid).append('<select name="colours_requested_and_loaded_on_gc" id="colours_requested_and_loaded_on_gc_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
			}else if(cons_indx == 54){
				$("#"+tdid).append('<select name="kitchen_design_loaded_on_gc" id="kitchen_design_loaded_on_gc_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
			}else if(cons_indx == 55){
				$("#"+tdid).append('<select name="developer_colour_sheet_created" id="developer_colour_sheet_created_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
			}else if(cons_indx == 56){
				$("#"+tdid).append('<select name="spec_loaded_on_gc" id="spec_loaded_on_gc_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
				...
				$("#"+tdid).append('<select name="render_requested" id="render_requested_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
			}else if(cons_indx == 60){
				$("#"+tdid).append('<select name="render_received" id="render_received_'+job_id+'" onblur="update_child(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option></select>');
...
function update_child(field_id,field_name){
	...
	if(cons_indx == 45){
		if(field_value == 'REQ'){
			$("#"+parent_id).delay(3000).css("background-color","red");
			$("#"+parent_id).delay(3000).css("color","white");
		}else{
			$("#"+parent_id).delay(3000).css("background-color","green");
			$("#"+parent_id).delay(3000).css("color","white");
		...
		<?php
			...
			<li id="<?php echo $p; ?>" class="accordion <?php echo $tab_display; ?>">
				...
				<thead>
					...
					<th style="width:145px;">FoundationType&nbsp;&nbsp;&nbsp;</th>
					...
					<th style="width:145px;">Builder Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[32]->display_type == 1){ ?>
			...
			<tbody id="<?php echo $month_id; ?>" class="tbody<?php echo $p; ?> connectedSortable">
				...
				{ 
					$design_bg = '';
					if($consent_info[$t]->design == 'REQ Brief'){$design_bg = 'background-color:yellow';}
					if($consent_info[$t]->design == 'Brief'){$design_bg = 'background-color:blue;color:white;';}
					if($consent_info[$t]->design == 'Hold'){$design_bg = 'background-color:red;color:white;';}
					if($consent_info[$t]->design == 'Sign'){$design_bg = 'background-color:orange';}
					if($consent_info[$t]->design == 'Consent'){$design_bg = 'background-color:#90ee90';}
				?>
				...
				<td class="close" id="51_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;">	
					<?php if($consent_info[$t]->kitchen_disign_type == "STD"){
								$ci->consent_model->send_consent_mail($consent_info[$t]->id,'kitchen_disign_type',$consent_info[$t]->job_no,$consent_info[$t]->consent_name);	
							}
				...
				{ 
				?>
				<td class="close" id="19_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;background-color:
				...
				{ 
				?>
				<td class="close" id="20_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;background-color:
				...
				{ 
				?>
				<td class="close" id="21_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;color:white; background-color:
				<?php 	
				...
				{ ?>
				<td class="close" id="28_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;">
					<?php if($consent_info[$t]->consent_out_but_no_builder == ''){
								echo "";
							}else{
									echo $consent_info[$t]->consent_out_but_no_builder;
							} ?>				
				</td>
				<?php } ?>
				...
				<?php 	
					...
					{ 
				?>
				<td class="close" id="34_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;">
				...
				<?php 	
					...
					{ 
				?>
				<td class="close" id="35_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->settlement_date != '0000-00-00'){ ?> background-color:#90ee90; color:white; <?php } ?>">
