	...
	$('.consent_table tr td').dblclick(function(e){
		...
		if($("#"+tdid).hasClass("close")){
			...
			if(cons_indx == 0){
				...
				$("#"+tdid).append('<select name="pre_construction_sign" id="pre_construction_sign_'+job_id+'" onblur="update_consent(this.id,this.name);" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="REQ">REQ</option><option value="Date">Date</option><option value="N/A">N/A</option></select>');
			}else if(cons_indx == 1){
				var bc_val = $('#10_col_'+job_id).text().replace(/\s+/g, "");
				var unconditional_date_val = $('#25_col_'+job_id).text().replace(/\s+/g, "");
				if( bc_val != '' && unconditional_date_val != '' ){
					$("#"+tdid).html(tdval);
				}else{
				...
				$("#"+tdid).append('<input type="text" name="pricing_requested" id="pricing_requested_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 49){
				$("#"+tdid).append('<input type="text" name="pricing_for_approval" id="pricing_for_approval_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 37){
				$("#"+tdid).append('<input type="text" name="price_approved_date" id="price_approved_date_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<input type="text" name="colours_requested_and_loaded_on_gc" id="colours_requested_and_loaded_on_gc_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 54){
				$("#"+tdid).append('<input type="text" name="kitchen_design_loaded_on_gc" id="kitchen_design_loaded_on_gc_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 55){
				$("#"+tdid).append('<input type="text" name="developer_colour_sheet_created" id="developer_colour_sheet_created_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 56){
				$("#"+tdid).append('<input type="text" name="spec_loaded_on_gc" id="spec_loaded_on_gc_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<input type="text" name="render_requested" id="render_requested_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 60){
				$("#"+tdid).append('<input type="text" name="render_received" id="render_received_'+job_id+'" onchange="update_consent(this.id,this.name);" class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<input type="text" name="pim_logged" id="pim_logged_'+job_id+'" class="live_datepicker" onchange="update_consent(this.id,this.name);"  value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 6){
				$("#"+tdid).append('<input type="text" name="drafting_issue_date" id="drafting_issue_date_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 7){
				...
				$("#"+tdid).append('<input type="text" name="date_job_checked" id="date_job_checked_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<input type="text" name="expected_date_to_lodge_bc" id="expected_date_to_lodge_bc_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 16){
				$("#"+tdid).append('<input type="text" name="date_logged" id="date_logged_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 17){
				$("#"+tdid).append('<input type="text" name="date_issued" id="date_issued_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 18){
				$("#"+tdid).append('<input type="text" name="actual_date_issued" id="actual_date_issued_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<input type="text" name="unconditional_date" id="unconditional_date_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
			}else if(cons_indx == 26){
				$("#"+tdid).append('<input type="text" name="handover_date" id="handover_date_'+job_id+'"  onchange="update_consent(this.id,this.name);"  class="live_datepicker" value="'+tdval+'" autofocus="autofocus">');
				...
				$("#"+tdid).append('<select name="settlement_date" id="settlement_date_'+job_id+'" onchange="set_date_box(this.value,this.id,this.name)"><option value="">--Select--</option><option value="Date">Date</option><option value="Days">Days</option></select>');
...
function set_date_box(value,item_id,item_name){
	...
	if(value == "Date"){
		...
		$("#"+parent_id).append('<input type="text" name="'+item_name+'" id="'+item_id+'" onchange="update_consent(this.id,this.name)">' );
		$("#"+item_id).remove();
	}
} 
...
function update_consent(field_id,field_name){
	...
	var field_value = $("#"+field_id).val().trim();
    ...
    // parent child column value change at a time
	var has_child = 0;
	...
	if(cons_indx == 50){
		if(field_value != ''){
			$("#"+parent_id).append("$");
			$("#"+parent_id).css("background-color","#90ee90");
    ...
    // for settlement date
	if(cons_indx == 35){
       	var days = $("#settlement_date_"+job_id).val();
		var settlement_date = $("#settlement_date_"+job_id+"1").val();
		if(days != null){
			title_date = $("#34_col_"+job_id).text().replace(/\s+/g, "");
			if(title_date != ""){
				date_split = title_date.split("-");
				rtitle_date = '20' + date_split[2] + '/' + date_split[1] + '/' + date_split[0] ;
				var otitle_date = new Date(rtitle_date);
				settlement_date = otitle_date.setDate(otitle_date.getDate() + parseInt(days));
				sdate = new Date(settlement_date);
				...
				alert('Title date has no value. Please insert title date first!');
				field_value = '';
	...
	$.ajax({
		...
		success: function(data){
			...
			var consent_name = $("#0_col_"+job_id).text().replace(/\s+/g, "");
			var contract_type = $("#12_col_"+job_id).text().replace(/\s+/g, "");

			var design_approval_date = $("#2_col_"+job_id).text().replace(/\s+/g, ""); 
			design_approval_date_time = consent_date_time(design_approval_date);

			var ok_to_release_to_marketing_b = $("#47_col_"+job_id).text().replace(/\s+/g, " "); 
			ok_to_release_to_marketing = ok_to_release_to_marketing_b.trim();

			pricing_requested = $("#48_col_"+job_id).text().replace(/\s+/g, "");
			pricing_requested_time = consent_date_time(pricing_requested);

			pricing_for_approval = $("#49_col_"+job_id).text().replace(/\s+/g, "");

			price_approved_date = $("#37_col_"+job_id).text().replace(/\s+/g, "");
			price_approved_date_time = consent_date_time(price_approved_date);

			council = $("#9_col_"+job_id).text().replace(/\s+/g, "");

			kitchen_disign_requested_wb = $("#52_col_"+job_id).text().replace(/\s+/g, "");
			kitchen_disign_requested = kitchen_disign_requested_wb.trim();
		
			colours_requested_and_loaded_on_gc = $("#53_col_"+job_id).text().replace(/\s+/g, "");
			colours_requested_and_loaded_on_gc_time = consent_date_time(colours_requested_and_loaded_on_gc);

			render_requested = $("#59_col_"+job_id).text().replace(/\s+/g, "");
			render_requested_time = consent_date_time(render_requested);

			render_received = $("#60_col_"+job_id).text().replace(/\s+/g, "");
			render_received_time = consent_date_time(render_received);
			...
			if(cons_indx == 0){
				...
				$("#consent_id_"+job_id).remove();
				$("#consent_color_"+job_id).remove();	
			}else if(cons_indx == 45){ // condition for Pre-construction Sign
				if(field_value == ''){
					bg_color = '';
					text_color = '';
				}else if(field_value == 'REQ'){
					bg_color = 'red';
					text_color = 'white';
				}else if(field_value == 'N/A'){
					bg_color = '#fff';
					text_color = 'black';
				}else{
					bg_color = '#90ee90';
				...
				$("#"+parent_id).append(field_value);
				$("#"+parent_id).css("background-color",bg_color);
				$("#"+parent_id).css("color",text_color);
			}else if(cons_indx == 2){ // condition for Design Approval Date

				var twenty_days_before = days_add_deduct('-20');
				res_date_df = new Date(twenty_days_before);
				res_date_time = res_date_df.getTime();

				if(field_value == ''){
					bg_color = '';
					text_color = '';

					// related conditions (Design column)
					$.ajax({
						type:'GET',
						dataType: 'html', 
						data: { val: 'Brief'}, 
						url:window.Url + 'consent/consent_update/design/'+job_id,
						success: function(data){
					...
					$("#1_col_"+job_id).empty();
					$("#1_col_"+job_id).append("Brief");
					$("#1_col_"+job_id).css("background-color","blue");
					$("#1_col_"+job_id).css("color","white");
					...
					$("#1_col_"+job_id).empty();
					$("#1_col_"+job_id).append("REQ Brief");
					$("#1_col_"+job_id).css("background-color","yellow");
					$("#1_col_"+job_id).css("color","black");

					// related conditions (Ok to release to Marketing column)
					if(ok_to_release_to_marketing == ''){
						$("#47_col_"+job_id).empty();
						$("#47_col_"+job_id).append("REQ");
						$("#47_col_"+job_id).css("background-color","red");
						$("#47_col_"+job_id).css("color","white");
					}
				...
				design_approval_date_time = consent_date_time(field_value);

				// related conditions (below for pricing requested)
				if(field_value != '' && contract_type == "HL" && design_approval_date_time > res_date_time && !isDate(pricing_requested) ){
					$("#48_col_"+job_id).empty();
					$("#48_col_"+job_id).append("REQ");
					$("#48_col_"+job_id).css("background-color","red");
					$("#48_col_"+job_id).css("color","white");
				}else if(design_approval_date_time < res_date_time && field_value != '' && !isDate(pricing_requested)){
					$("#48_col_"+job_id).empty();
					$("#48_col_"+job_id).append("OVERDUE");
					$("#48_col_"+job_id).css("background-color","red");
					$("#48_col_"+job_id).css("color","white");
				}

				// related conditions (below for Pricing for approval)
				var res_date_time = days_add_deduct('-5');
				
				if(field_value != '' && contract_type == "HL" && design_approval_date_time > res_date_time && !isDate(pricing_requested) && !isDate(pricing_for_approval) ){
					$("#49_col_"+job_id).empty();
					$("#49_col_"+job_id).append("DUE");
					$("#49_col_"+job_id).css("background-color","orange");
					$("#49_col_"+job_id).css("color","black");
				}else if(design_approval_date_time < res_date_time && field_value != '' && !isDate(pricing_requested) && !isDate(pricing_for_approval)){
					$("#49_col_"+job_id).empty();
					$("#49_col_"+job_id).append("OVERDUE");
					$("#49_col_"+job_id).css("background-color","red");
					$("#49_col_"+job_id).css("color","white");
				}

			}else if(cons_indx == 47){ // condition for OK To Release To Marketing
				if(field_value == '' && ( contract_type == 'EQ' || contract_type == 'BC' )){
					$("#"+parent_id).append("N/A");
					$("#"+parent_id).css("background-color","");
					$("#"+parent_id).css("color","black");	
				}
				...
				// related conditions ( for color requested and loaded on GC )
				if(field_value != '' && price_approved_date != ""){
					$("#53_col_"+job_id).empty();
					$("#53_col_"+job_id).append("REQ");
					$("#53_col_"+job_id).css("background-color","red");
					$("#53_col_"+job_id).css("color","white");	
					...
					$.ajax({
						...
						dataType: 'html', 
						data: { val: today}, 
						url:window.Url + 'consent/consent_update/colours_requested_and_loaded_on_gc_req_date/'+job_id,
						success: function(data){
			...
			}else if(cons_indx == 48){ // Condition for Pricing requested 
				var res_date_time = days_add_deduct('-20');
				if(field_value == '' && ( contract_type == 'EQ' || contract_type == 'BC')){
					$("#"+parent_id).append("N/A");
					$("#"+parent_id).css("background-color","");
					$("#"+parent_id).css("color","black");
				}else if(design_approval_date != '' && contract_type == "HL" && design_approval_date_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(design_approval_date_time < res_date_time && design_approval_date != '' && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else{
					$("#"+parent_id).append(field_value);
			...
			}else if(cons_indx == 49){ // Condition for Pricing for approval 
				var res_date_time = days_add_deduct('-5');
				if(field_value == '' && ( contract_type == 'EQ' || contract_type == 'BC')){
					$("#"+parent_id).append("N/A");
					$("#"+parent_id).css("background-color","");
					$("#"+parent_id).css("color","black");
				}else if(design_approval_date != '' && contract_type == "HL" && design_approval_date_time > res_date_time && !isDate(pricing_requested) && field_value == '' ){
					$("#"+parent_id).append("DUE");
					$("#"+parent_id).css("background-color","orange");
					$("#"+parent_id).css("color","black");
				}else if(pricing_requested_time < res_date_time && !isDate(pricing_requested) && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
			...
			}else if(cons_indx == 37){ // condition for Price Approved Date 
				if(field_value == '' && ( contract_type == "EQ" || contract_type == "BC")){
					$("#"+parent_id).append("N/A");
					$("#"+parent_id).css("background-color","");
				}else if(field_value != ''){
				...
				// related conditions ( for color requested and loaded on GC )
				if(field_value != '' && ok_to_release_to_marketing == "Yes"){
					$("#53_col_"+job_id).empty();
					$("#53_col_"+job_id).append("REQ");
					$("#53_col_"+job_id).css("background-color","red");
					$("#53_col_"+job_id).css("color","white");
			...
			}else if(cons_indx == 51){ // condition for kitchen design type
				if(field_value != ''){
					$("#"+parent_id).append(field_value);
					$("#"+parent_id).css("background-color","#90ee90");
					$("#"+parent_id).css("color","black");
					...
					if(field_value == 'STD'){ 
						var kitchen_disign_type = 'kitchen_disign_type_std';
					}else{
						var kitchen_disign_type = 'kitchen_disign_type_designer';
					}
					...
					$.ajax({
						...
						url:window.Url + 'consent/send_consent_mail/'+pid+'/'+kitchen_disign_type+'/'+job_id+'/'+consent_name+'/'+council,
						success: function(data){
			...
			}else if(cons_indx == 52){ // Condition for Kitchen Design Requested 
				var res_date_time = days_add_deduct('20');
				if(field_value == '' && ( contract_type == 'EQ' || contract_type == 'BC')){
					$("#"+parent_id).append("N/A");
					$("#"+parent_id).css("background-color","");
					$("#"+parent_id).css("color","black");
				}else if(pricing_for_approval != '' && design_approval_date != '' && ok_to_release_to_marketing == "Yes" && design_approval_date_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(design_approval_date_time < res_date_time && design_approval_date != '' && field_value == '' ){
			...
			}else if(cons_indx == 53){ // Condition for Colours Requested & Loaded on GC 
				var res_date_time = days_add_deduct('20');
				if(pricing_for_approval != '' && design_approval_date != '' && ok_to_release_to_marketing == "Yes" && design_approval_date_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(design_approval_date_time < res_date_time && design_approval_date != '' && field_value == '' ){
			...
			}else if(cons_indx == 54){ // Condition for  Kitchen Design Loaded on GC 
				var res_date_time = days_add_deduct('20');
				if(kitchen_disign_requested = 'REQ' && ok_to_release_to_marketing == "Yes" &&  res_date_time < design_approval_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
			...
			}else if(cons_indx == 55){ // Condition for Developer Colour Sheet Created
				var res_date_time = days_add_deduct('-10');
				if(isDate(colours_requested_and_loaded_on_gc) && colours_requested_and_loaded_on_gc_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(colours_requested_and_loaded_on_gc_time < res_date_time && isDate(colours_requested_and_loaded_on_gc) && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
			...
			}else if(cons_indx == 56){ // condition for Spec Loaded on GC
				var res_date_time = days_add_deduct('-20');
				
				if(price_approved_date != '' && contract_type == 'HL' && price_approved_date_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(price_approved_date_time < res_date_time && price_approved_date != '' && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
			...
			}else if(cons_indx == 57 || cons_indx == 58){ // condition for Loaded on Intranet and Website
				var res_date_time = days_add_deduct('-10');

				if(price_approved_date != '' && price_approved_date_time > res_date_time && field_value == '' ){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(price_approved_date_time < res_date_time && price_approved_date != '' && field_value == '' ){
			...
			}else if(cons_indx == 59){ // condition for Render Requested 
				if(colours_requested_and_loaded_on_gc != '' && field_value == ''){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
					...
					// Related condition for Render Received
					var res_date_time = days_add_deduct('-20');
					render_requested_time = consent_date_time(field_value);
					if( res_date_time > render_requested_time && isDate(field_value)){
						$("#60_col_"+job_id).empty();
						$("#60_col_"+job_id).append("OVERDUE");
						$("#60_col_"+job_id).css("background-color","red");
						$("#60_col_"+job_id).css("color","white");
					}else if(res_date_time < render_requested_time && isDate(field_value)){
						$("#60_col_"+job_id).empty();
						$("#60_col_"+job_id).append("REQ");
						$("#60_col_"+job_id).css("background-color","red");
						$("#60_col_"+job_id).css("color","white");
					}
			...
			}else if(cons_indx == 60){ // condition for Render Received  
				var res_date_time = days_add_deduct('-20');
				if( res_date_time > render_requested_time && isDate(render_requested) && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(res_date_time < render_requested_time && isDate(render_requested) && field_value == ''){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
					...
					// Related condition for Brochure
					render_received_time = consent_date_time(field_value);
					var res_date_time = days_add_deduct('-10');
					
					if( res_date_time > render_received_time && isDate(field_value)){
						$("#61_col_"+job_id).empty();
						$("#61_col_"+job_id).append("OVERDUE");
						$("#61_col_"+job_id).css("background-color","red");
						$("#61_col_"+job_id).css("color","white");
					}else if(res_date_time < render_received_time && isDate(field_value)){
						$("#61_col_"+job_id).empty();
						$("#61_col_"+job_id).append("REQ");
						$("#61_col_"+job_id).css("background-color","red");
						$("#61_col_"+job_id).css("color","white");
					}
				}				
			}else if(cons_indx == 61){ // condition for Brochure 
				var res_date_time = days_add_deduct('-10');
				if( res_date_time > render_received_time && isDate(render_received) && field_value == '' ){
					$("#"+parent_id).append("OVERDUE");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(res_date_time < render_received_time && isDate(render_received) && field_value == ''){
					$("#"+parent_id).append("REQ");
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");
				}else if(field_value == ''){
			...
			}else if(cons_indx == 6){ // condition for Drafting  Issue Date
				if(field_value !=''){
					$("#"+parent_id).append(field_value);
					$("#"+parent_id).css("background-color","#90ee90");
					$("#"+parent_id).css("color","black");	
			...
			}else if(cons_indx == 14){                        // condition for Variation Pending 
				if(field_value =='Yes'){
					$("#"+parent_id).append(field_value);
					$("#"+parent_id).css("background-color","red");
					$("#"+parent_id).css("color","white");	
			...
			}else if(cons_indx == 15){                        // condition for Foundation Type 
				$("#"+field_id).parent().append(field_value);
				$("#foundation_type1_"+job_id).remove();
				$("#foundation_type2_"+job_id).remove();
			}else if(cons_indx == 16 || cons_indx == 17 || cons_indx == 26 || cons_indx == 25){     // condition for  Consent Lodged & Consent Issued 
				if(field_value !=''){
					$("#"+parent_id).append(field_value);
					$("#"+parent_id).css("background-color","#90ee90");
					$("#"+parent_id).css("color","black");	
			...
			}else if(cons_indx == 7){                        // condition for Consent By
				var consent_by = $('#consent_by_'+job_id+' option:selected').text();
				$("#"+field_id).parent().append(consent_by);	
			}else if(cons_indx == 23){                        // condition for Project Manager
				var project_manager = $('#project_manager_'+job_id+' option:selected').text();
				$("#"+field_id).parent().append(project_manager);	
			}else if(cons_indx == 27){                        // condition for Builder
				var builder = $('#builder_'+job_id+' option:selected').text();
				$("#"+field_id).parent().append(builder);	
			}else if(cons_indx == 34){                        // condition for Title date
			...
			}else if(cons_indx == 35){                        // condition for Settlement Date
				$("#"+field_id).parent().append(field_value);
				$("#settlement_date_"+job_id).remove();
				$("#settlement_date_"+job_id+"1").remove();
				if(field_value == ''){
					$("#"+parent_id).css("background-color","");	
				}else{
					$("#"+parent_id).css("background-color","orange");
...
function days_add_deduct(days_num){
	var now = new Date();
    var day = now.getDate();
    var dayb = now.setDate(day + parseInt(days_num));
    res_date = new Date(dayb );
    var dd = res_date.getDate();
    var mm = res_date.getMonth() + 1;
    var yyyy = res_date.getFullYear();
    days_before = yyyy + '-'+ mm + '-'+ dd;
	res_date = days_before.replace(/\b(\d{1})\b/g, '0$1');
	res_date_df = new Date(res_date);
	return res_date_time = res_date_df.getTime();
}

function consent_date_time(date_value){
	date_value_split = date_value.split("-");
	date_value_ymd = '20' + date_value_split[2] + '/' + date_value_split[1] + '/' + date_value_split[0] ;
	date_value_df = new Date(date_value_ymd);
	return date_value_time = date_value_df.getTime();
}
...
function selectrow(tr_id,tr_class,tab_id)
{	
	if($("#" + tr_id).hasClass( 'checked' ) == false){
		document.getElementById('delete_consent_item').href= window.Url + 'consent/consent_delete/'+tr_id+'/'+tab_id;
...
<div id="consent_list" style="clear:both">
	...
	<ul class="accordions toggles">
		<?php
			...
			//$all_co_des = $ci->consent_model->getallcolumndes()->descrition;
			...
			<li id="<?php echo $p; ?>" class="accordion <?php echo $tab_display; ?>">
				...
				<thead>
					<th style="width:90px;">&nbsp;&nbsp;&nbsp;&nbsp;Job&nbsp;No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php if($nuser_permission_type[1]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(1)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consent&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[45]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(45)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Pre-construction&nbsp; sign</th>
					<?php } if($nuser_permission_type[1]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(2)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;Design&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[46]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(46)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;Designer&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[2]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(3)->description; ?>" style="width:115px;">&nbsp;Design&nbsp;Approval Date</th>
					<?php } if($nuser_permission_type[47]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(47)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Ok&nbsp;to&nbsp;release&nbsp;to&nbsp;&nbsp; Marketing</th>
					<?php } if($nuser_permission_type[48]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(48)->description; ?>" style="width:115px;">&nbsp;Pricing&nbsp;requested&nbsp;</th>
					<?php } if($nuser_permission_type[49]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(49)->description; ?>" style="width:115px;">Pricing&nbsp;for&nbsp;approval</th>
					<?php } if($nuser_permission_type[33]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(33)->description; ?>" style="width:115px;">Price&nbsp;Approved&nbsp;Date</th>
					<?php } if($nuser_permission_type[50]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(50)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Approved&nbsp;For&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sale&nbsp;Price</th>
					<?php } if($nuser_permission_type[51]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(51)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Kitchen&nbsp;Design&nbsp;&nbsp;&nbsp;&nbsp; Type</th>
					<?php } if($nuser_permission_type[52]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(52)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Kitchen&nbsp;Design&nbsp;&nbsp;&nbsp;&nbsp; Requested</th>
					<?php } if($nuser_permission_type[53]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(53)->description; ?>" style="width:115px;">Colours&nbsp;Requested & Loaded&nbsp;on&nbsp;GC</th>
					<?php } if($nuser_permission_type[54]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(54)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Kitchen&nbsp;Design&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Loaded on GC</th>
					<?php } if($nuser_permission_type[55]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(55)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Developer&nbsp;Colour Sheet Created</th>
					<?php } if($nuser_permission_type[56]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(56)->description; ?>" style="width:115px;">Spec&nbsp;Loaded&nbsp;on&nbsp;GC</th>
					<?php } if($nuser_permission_type[57]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(57)->description; ?>" style="width:115px;">Loaded&nbsp;on&nbsp;Intranet</th>
					<?php } if($nuser_permission_type[58]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(58)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Website&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[59]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(59)->description; ?>" style="width:115px;">Render&nbsp;Requested&nbsp;</th>
					<?php } if($nuser_permission_type[60]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(60)->description; ?>" style="width:115px;">Render&nbsp;Received&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[61]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(61)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Brochure&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[3]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(4)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pim&nbsp;&nbsp;Lodged&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[6]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(7)->description; ?>" style="width:115px;">Drafting&nbsp;&nbsp;Issue&nbsp;Date</th>
					<?php } if($nuser_permission_type[7]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(8)->description; ?>" style="width:115px;">&nbsp;Consent&nbsp;&nbsp;by&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[8]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(9)->description; ?>" style="width:115px;">Action&nbsp;&nbsp;Required&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[9]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(10)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Council&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[29]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(30)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LBP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[30]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(31)->description; ?>" style="width:115px;">Date&nbsp;Job&nbsp;Checked&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[10]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(11)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bc&nbsp;Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[11]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(12)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;No.&nbsp;Units&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[12]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(13)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Contract&nbsp;Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[13]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(14)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Type&nbsp;of&nbsp;Build&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[14]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(15)->description; ?>" style="width:115px;">Variation&nbsp;Pending&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[15]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(16)->description; ?>" style="width:115px;">Foundation&nbsp;Type&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[62]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(62)->description; ?>" style="width:115px;">Resource&nbsp;Consent </th>
					<?php } if($nuser_permission_type[63]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(63)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;RC&nbsp;Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[64]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(64)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Expected&nbsp;Date&nbsp;to&nbsp; Lodge&nbsp;BC&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[16]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(17)->description; ?>" style="width:115px;">&nbsp;Consent&nbsp;Lodged&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[17]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(18)->description; ?>" style="width:115px;">&nbsp;&nbsp;Consent&nbsp;Issued&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[18]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(18)->description; ?>" style="width:115px;">Actual&nbsp;Date&nbsp;Issued</th>		
					<?php } if($nuser_permission_type[18]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(19)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Days&nbsp;in&nbsp;Council&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[65]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(65)->description; ?>" style="width:115px;">Water&nbsp;Connection&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[66]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(66)->description; ?>" style="width:115px;">Vehicle&nbsp;Crossing&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[19]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(20)->description; ?>" style="width:115px;">Order&nbsp;Site&nbsp;Levels&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[20]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(21)->description; ?>" style="width:115px;">Order&nbsp;Soil&nbsp;Report&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[21]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(22)->description; ?>" style="width:115px;">Septic&nbsp;Tank&nbsp;Approval</th>		
					<?php } if($nuser_permission_type[70]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(70)->description; ?>" style="width:115px;">&nbsp;Drainage&nbsp;Testing&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[22]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(23)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Dev&nbsp;Approval&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>	
					<?php } if($nuser_permission_type[32]->display_type == 1){ ?>
					<th title="" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Landscape&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[33]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(34)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MSS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[23]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(24)->description; ?>" style="width:115px;">&nbsp;&nbsp;Project&nbsp;Manager&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[25]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(26)->description; ?>" style="width:115px;">Unconditional&nbsp;Date&nbsp;</th>		
					<?php } if($nuser_permission_type[26]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(27)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Handover&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[27]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(28)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Builder&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>			
					<?php } if($nuser_permission_type[32]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(67)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For&nbsp;Sale&nbsp;Sign&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[68]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(68)->description; ?>" style="width:115px;">Code&nbsp;of&nbsp;Compliance</th>		
					<?php } if($nuser_permission_type[32]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(32)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[35]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(35)->description; ?>" style="width:115px;">Settlement&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>		
					<?php } if($nuser_permission_type[67]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(69)->description; ?>" style="width:115px;">&nbsp;&nbsp;&nbsp;Photo's&nbsp;Taken&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<?php } if($nuser_permission_type[36]->display_type == 1){ ?>
					<th title="<?php echo $ci->consent_model->getallcolumndes(36)->description; ?>" style="width:500px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Notes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tbody id="<?php echo $month_id; ?>" class="tbody<?php echo $p; ?> connectedSortable">
				...
				<tr id="consent_<?php echo $consent_info[$t]->month_id.'_'.$consent_info[$t]->id; ?>" class="<?php echo $parent_class; ?>"  onclick="selectrow(this.id,this.className,<?php echo $p; ?>);  ">
				<td id="job_<?php echo $month_id; ?>_<?php echo $n; ?>" onclick="<?php echo $toggle; ?>" style="width:79px; height:45px; background-color:white;" ><div class="<?php echo $toggle_class; ?>" style="float:left;margin-right:5px;" ></div><div id="jobnumber" style="float:left"><?php echo $consent_info[$t]->job_no; ?></div></td>
				...
				if($nuser_permission_type[1]->display_type == 1)
				{
					...
					if($consent_info[$t]->unconditional_date != '0000-00-00'){
						$bg_consent_name = "background-color:white;color:red;";
					}else if($consent_info[$t]->consent_color=='72D660' or $consent_info[$t]->date_logged != '0000-00-00'){ 
						$bg_consent_name = 'background-color:#90ee90'; }
					else{ 
						$bg_consent_name = 'background-color:#'.$consent_info[$t]->consent_color;
					}  	
				?>
				<td class="close" id="0_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_consent_name; ?>">		
				...
				{ 
					...
					if($consent_info[$t]->design == '' && $consent_info[$t]->unconditional_date == '0000-00-00' && $consent_info[$t]->design_approval_date == '0000-00-00' && $consent_info[$t]->pricing_for_approval == '0000-00-00' && $consent_info[$t]->date_logged == '0000-00-00' && $consent_info[$t]->drafting_issue_date == '0000-00-00' && $consent_info[$t]->contract_type== '' ){
						$text_design = '';
						$bg_design = '';
					}elseif($consent_info[$t]->contract_type=='BC' && $consent_info[$t]->design == '' ){
						$text_design = 'Allo';
						$bg_design = 'background-color:#90ee90;color:black';
					}elseif(($consent_info[$t]->unconditional_date != '0000-00-00' && $consent_info[$t]->design_approval_date != '0000-00-00')){
						$text_design = 'REQ Brief';
						$bg_design = 'background-color:yellow;color:black';
					}elseif(($consent_info[$t]->unconditional_date == '0000-00-00' && $consent_info[$t]->design_approval_date != '0000-00-00') or $consent_info[$t]->design =='Sign' ){
						$text_design = 'Sign';
						$bg_design = 'background-color:orange';
					}elseif(($consent_info[$t]->unconditional_date != '0000-00-00' && $consent_info[$t]->design_approval_date == '0000-00-00') or $consent_info[$t]->pricing_for_approval != '0000-00-00'){
						$text_design = 'Allo';
						$bg_design = 'background-color:orange;color:white;';
					}elseif($consent_info[$t]->drafting_issue_date != '0000-00-00' or $consent_info[$t]->date_logged != '0000-00-00' or $consent_info[$t]->design =='Consent' ){
						$text_design = 'Consent';
						$bg_design = 'background-color:#90ee90;color:black';
					}elseif($consent_info[$t]->design =='REQ Brief'){
						$text_design = 'REQ Brief';
						$bg_design = 'background-color:yellow;color:black';
					}elseif($consent_info[$t]->design =='Hold'){
						$text_design = 'Hold';
						$bg_design = 'background-color:red;color:white;';
					}elseif($consent_info[$t]->design =='Brief'){
						$text_design = 'Brief';
						$bg_design = 'background-color:blue;color:white;';
					}elseif($consent_info[$t]->design =='Allo'){
						$text_design = 'Allo';
						$bg_design = 'background-color:orange;color:white;';
					}
					...
					$ci->consent_model->update_consent($consent_info[$t]->job_no, $update_data);

				?>
				<td class="close" id="1_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_design;?>">
				...
				{ 
					$text_design_approval_date = '';
					$bg_design_approval_date = '';
					if($consent_info[$t]->design_approval_date == '0000-00-00' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						$text_design_approval_date = 'N/A';
						$bg_design_approval_date = '';
					}elseif($consent_info[$t]->design_approval_date != '0000-00-00'){
						$text_design_approval_date = $this->wbs_helper->to_report_date($consent_info[$t]->design_approval_date);
						$bg_design_approval_date = 'background-color:#90ee90;color:black;';
					}
				?>
				<td class="close" id="2_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_design_approval_date; ?>" >
					<?php echo $text_design_approval_date; ?>
				</td>
				<?php 	} ?>
				...
				<?php if($nuser_permission_type[47]->display_type == 1){
						...
						if($consent_info[$t]->ok_to_release_to_marketing == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_ok_to_release_to_marketing = 'N/A';
							$bg_ok_to_release_to_marketing = '';
						}elseif($consent_info[$t]->design_approval_date != "0000-00-00" && $consent_info[$t]->ok_to_release_to_marketing == ''){
							$text_ok_to_release_to_marketing = 'REQ';
							$bg_ok_to_release_to_marketing = 'background-color:red;color:white;';
						}elseif($consent_info[$t]->ok_to_release_to_marketing == "Yes"){
							$text_ok_to_release_to_marketing = 'Yes';
							$bg_ok_to_release_to_marketing = 'background-color:#90ee90;color:black;';
				...
				<td class="close" id="47_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_ok_to_release_to_marketing;  ?>">	
					<?php 	echo $text_ok_to_release_to_marketing; ?> 		
				</td>
				<?php 	} ?>
				...
				<?php if($nuser_permission_type[48]->display_type == 1){ 
					...
					if($consent_info[$t]->pricing_requested == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						$text_pricing_requested = 'N/A';
						$bg_pricing_requested = '';
					}elseif($consent_info[$t]->design_approval_date!='0000-00-00' && $consent_info[$t]->contract_type == 'HL' && $consent_info[$t]->design_approval_date > $twenty_days_before && $consent_info[$t]->pricing_requested =='0000-00-00'){
					...
					}elseif($consent_info[$t]->design_approval_date < $twenty_days_before && $consent_info[$t]->design_approval_date!='0000-00-00' && $consent_info[$t]->pricing_requested =='0000-00-00'){
						...
						$bg_pricing_requested = 'background-color:#90ee90;color:black;';
				...
				<?php if($nuser_permission_type[49]->display_type == 1){ 
					...
					if($consent_info[$t]->pricing_for_approval == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						$text_pricing_for_approval = 'N/A';
						$bg_pricing_for_approval = '';
					}elseif($consent_info[$t]->design_approval_date!='0000-00-00' && $consent_info[$t]->contract_type == 'HL' && $consent_info[$t]->pricing_requested =='0000-00-00' && $consent_info[$t]->pricing_for_approval=='0000-00-00' ){
						...
						$bg_pricing_for_approval = 'background-color:#90ee90;color:black;';
					}
				...
				{ 
					...
					if($consent_info[$t]->price_approved_date == '0000-00-00' && $consent_info[$t]->pricing_for_approval != '0000-00-00'){
						$txt_price_approved_date = 'REQ';
						$bg_price_approved_date = 'background-color:red;color:white;';
					}elseif($consent_info[$t]->price_approved_date == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
						$txt_price_approved_date = 'N/A';
						$bg_price_approved_date = '';
					}elseif($consent_info[$t]->price_approved_date != '0000-00-00'){
						$txt_price_approved_date = $this->wbs_helper->to_report_date($consent_info[$t]->price_approved_date);
						$bg_price_approved_date = 'background-color:#90ee90; color:black;';
					}
				?>
				<td class="close" id="37_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_price_approved_date; ?>" >
					<?php echo $txt_price_approved_date; ?>
				</td>
				<?php 	} ?>

				<?php if($nuser_permission_type[50]->display_type == 1){ ?>
				<td class="close" id="50_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;background-color:<?php if($consent_info[$t]->approved_for_sale_price!='') {?> #90ee90; color:black;<?php } ?>">	
				...
				<?php if($nuser_permission_type[51]->display_type == 1){
					...
					if($consent_info[$t]->kitchen_disign_type == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){		
						$text_kitchen_disign_type = 'N/A';						
						$bg_kitchen_disign_type = '';
					}elseif($consent_info[$t]->kitchen_disign_type != ''){	
						$text_kitchen_disign_type = $consent_info[$t]->kitchen_disign_type;
						$bg_kitchen_disign_type = 'background-color:#90ee90; color:black;';
					}
					

					if($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date != '0000-00-00' && $consent_info[$t]->kitchen_disign_type == "STD"){
					...
					if($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date != '0000-00-00' && $consent_info[$t]->kitchen_disign_type == "DESIGNER"){
				 ...
				 ?>
				<td class="close" id="51_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_kitchen_disign_type; ?>">	
				<?php 	
					 	echo $text_kitchen_disign_type; 
				?>		
				</td>
				<?php 	} ?>
				...
				<?php if($nuser_permission_type[52]->display_type == 1){
					...
					if($consent_info[$t]->kitchen_disign_requested == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){		
						$text_kitchen_disign_requested = 'N/A';						
						$bg_kitchen_disign_requested = '';
					}elseif( $consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date !='0000-00-00' && $consent_info[$t]->kitchen_disign_type != ''){
					...
					}elseif($twenty_days_before > $consent_info[$t]->design_approval_date && $consent_info[$t]->design_approval_date !='0000-00-00' ){
				...
				<?php if($nuser_permission_type[53]->display_type == 1){ 
					...
					if($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->pricing_for_approval !='0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc == '0000-00-00' && $twenty_days_before < $consent_info[$t]->design_approval_date){
					...
					}elseif($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date !='0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc == '0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc_req_date > $ten_days_before ){
						$text_colours_requested_and_loaded_on_gc = "REQ";
						$bg_colours_requested_and_loaded_on_gc = "background-color:red;color:white;";
					}elseif($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->price_approved_date !='0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc == '0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc_req_date < $ten_days_before ){
						...
						$bg_colours_requested_and_loaded_on_gc = "background-color:#90ee90;color:black;";
					}
				?>
				...
				<?php if($nuser_permission_type[54]->display_type == 1){ 
					...
					if($consent_info[$t]->kitchen_disign_requested == 'REQ' OR ($consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $twenty_days_before < $consent_info[$t]->design_approval_date)){
				...
				<?php if($nuser_permission_type[55]->display_type == 1){ 
						...
						if( $consent_info[$t]->colours_requested_and_loaded_on_gc != '0000-00-00' && $consent_info[$t]->colours_requested_and_loaded_on_gc > $ten_days_before  && $consent_info[$t]->developer_colour_sheet_created == '0000-00-00' ){
							...
							$bg_developer_colour_sheet_created = "background-color:#90ee90;color:black;";
						}
				...
				<?php if($nuser_permission_type[56]->display_type == 1){ 
					...
					}elseif($consent_info[$t]->spec_loaded_on_gc == '' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_spec_loaded_on_gc = "N/A";
							$bg_spec_loaded_on_gc = '';
					}else{
				...
				<?php if($nuser_permission_type[57]->display_type == 1){ 
						...
						$ten_days_before = date('Y-m-d', strtotime('-10 days'));
						if($consent_info[$t]->loaded_on_intranet == '' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
								$text_loaded_on_intranet = "N/A";
								$bg_loaded_on_intranet = '';
						}elseif($consent_info[$t]->price_approved_date!='0000-00-00'){
				...
				<?php if($nuser_permission_type[58]->display_type == 1){ 
						...
						$ten_days_before = date('Y-m-d', strtotime('-10 days'));
						if($consent_info[$t]->website == '' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
								$text_website = "N/A";
								$bg_website = '';
						}elseif($consent_info[$t]->price_approved_date!='0000-00-00'){
							if( $ten_days_before > $consent_info[$t]->price_approved_date){
				...
				<?php if($nuser_permission_type[59]->display_type == 1){ 
						...
						if($consent_info[$t]->render_requested == '0000-00-00' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_render_requested = "N/A";
							$bg_render_requested = '';
						}elseif($consent_info[$t]->colours_requested_and_loaded_on_gc != '0000-00-00'  && $consent_info[$t]->render_requested == '0000-00-00' ){ 
							...
							$bg_render_requested = "background-color:#90ee90;color:black;";
				...
				<?php if($nuser_permission_type[60]->display_type == 1){ 
						...
						if($consent_info[$t]->render_received == '0000-00-00' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_render_received = "N/A";
							$bg_render_received = '';
							...
							$bg_render_received = "background-color:#90ee90;color:black;";
						}
				...
				<?php if($nuser_permission_type[61]->display_type == 1){ 
						...
						if($consent_info[$t]->brochure == '' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_brochure = "N/A";
							$bg_brochure = '';
				...
				?>
				<td class="close" id="6_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->drafting_issue_date != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
				...
				<td class="close" id="9_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;">
					...
					if($consent_info[$t]->design_approval_date!='0000-00-00' && ( $consent_info[$t]->council == 'Chch' or $consent_info[$t]->council == 'Waimak' or $consent_info[$t]->council == 'Hurunui' or $consent_info[$t]->council == 'Ashburton')){
					...
					if($consent_info[$t]->design_approval_date!='0000-00-00' && ($consent_info[$t]->council == 'Auckland' or $consent_info[$t]->council == 'Waikato')){
				...
				{ 
				?>
				<td class="close" id="16_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->date_logged != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
				...
				{ 
				?>
				<td class="close" id="17_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->date_issued != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
				...
				<?php if($nuser_permission_type[65]->display_type == 1){ 
					$text_water_connection = '';
					$bg_water_connection = '';

					if($consent_info[$t]->water_connection == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_water_connection = "REQ";
						$bg_water_connection = 'background-color:red; color:white';
					}else{
						$text_water_connection = $consent_info[$t]->water_connection;
						$bg_water_connection = 'color:black';
					}
				?>
				<td class="close" id="65_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_water_connection; ?>">	
					<?php 	echo $text_water_connection; ?>		
				</td>
				<?php 	} ?>
				
				<?php if($nuser_permission_type[66]->display_type == 1){
					$text_vehicle_crossing = '';
					$bg_vehicle_crossing = '';

					if($consent_info[$t]->vehicle_crossing == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_vehicle_crossing = "REQ";
						$bg_vehicle_crossing = 'background-color:red; color:white';
					}else{
						$text_vehicle_crossing = $consent_info[$t]->vehicle_crossing;
						$bg_vehicle_crossing = 'color:black';
					}
				 ?>
				<td class="close" id="66_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_vehicle_crossing; ?>">	
					<?php 	echo $text_vehicle_crossing; ?>		
				</td>
				<?php 	} ?>
				...
				{ 
					...
					if($consent_info[$t]->order_site_levels == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						...
						$bg_order_site_levels = 'background-color:#90ee90;color:black';
				...
				{ 
					...
					if($consent_info[$t]->order_soil_report == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						...
						$bg_order_soil_report = 'background-color:#90ee90;color:black';
				...
				{ 
					...
					if($consent_info[$t]->septic_tank_approval == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						...
						$bg_septic_tank_approval = 'background-color:#90ee90;color:black';
				...
				{ 
					...
					if($consent_info[$t]->drainage_testing == '' && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_drainage_testing = "REQ";
						$bg_drainage_testing = 'background-color:red; color:white';
					}elseif(trim($consent_info[$t]->drainage_testing) == ''){
						$text_drainage_testing = '';
						$bg_drainage_testing = '';
					}else{
						$text_drainage_testing = $consent_info[$t]->drainage_testing;
						$bg_drainage_testing = 'background-color:#90ee90;color:black';
					}
				?>
				<td class="close" id="70_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_drainage_testing; ?>">
					<?php echo $text_drainage_testing;  ?>
				</td>
				<?php 	} ?>
				...
				{ 
					...
					if(($consent_info[$t]->dev_approval == '' or $consent_info[$t]->dev_approval == 'REQ') && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_dev_approval = "REQ";
						$bg_dev_approval = 'background-color:red; color:white';
					}elseif($consent_info[$t]->dev_approval == 'FULL SENT'){
						$text_dev_approval = "FULL SENT";
						$bg_dev_approval = 'background-color:blue; color:white';
					}elseif($consent_info[$t]->dev_approval == 'FULL REC'){
						$text_dev_approval = "FULL REC";
						$bg_dev_approval = 'background-color:#90ee90;color:black';
					}elseif($consent_info[$t]->dev_approval == 'N/A'){
						$text_dev_approval = "N/A";
						$bg_dev_approval = 'background-color:white; color:black';
					}elseif($consent_info[$t]->dev_approval == 'PRE SENT'){
						$text_dev_approval = "PRE SENT";
						$bg_dev_approval = 'background-color:yellow; color:black';
					}elseif($consent_info[$t]->dev_approval == ''){
						$text_dev_approval = "";
						$bg_dev_approval = '';
					}elseif($consent_info[$t]->dev_approval == 'PRE REC'){
						$text_dev_approval = "PRE REC";
						$bg_dev_approval = 'background-color:yellow; color:black;';
					}
				?>
				<td class="close" id="22_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_dev_approval; ?>">
					<?php echo $text_dev_approval; ?>
				</td>
				<?php 	} ?>
				...
				{ 
					...
					if(($consent_info[$t]->landscape == '' or $consent_info[$t]->landscape == 'REQ') && ($consent_info[$t]->contract_type == 'HL' or $consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_landscape = "REQ";
						$bg_landscape = 'background-color:red; color:white';
					}elseif($consent_info[$t]->landscape == 'RECEIVED'){
						$text_landscape = "Received";
						$bg_landscape = 'background-color:#90ee90;color:black';
					}elseif($consent_info[$t]->landscape == 'SENT'){
						$text_landscape = "SENT";
						$bg_landscape = 'background-color:blue; color:white';
					}elseif($consent_info[$t]->landscape == 'N/A'){
						$text_landscape = "N/A";
						$bg_landscape = 'background-color:white; color:black';
					}

				?>
				<td class="close" id="32_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_landscape;  ?>">
					<?php echo $text_landscape; ?>
				</td>
				<?php 	} ?>
				...
				{ 
					...
					if($consent_info[$t]->mss == '' && $consent_info[$t]->drafting_issue_date !='0000-00-00'){
						$text_mss = 'REQ';
						$bg_mss = 'background-color:red; color:white';
					}elseif($consent_info[$t]->mss == 'REQ'){
						$text_mss = 'REQ';
						$bg_mss = 'background-color:red; color:white';
					}elseif($consent_info[$t]->mss == 'DONE'){
						$text_mss = 'DONE';
						$bg_mss = 'background-color:#90ee90;color:black';
					}else{
						$text_mss = $consent_info[$t]->mss;
						$bg_mss = '';
					}

				?>
				<td class="close" id="33_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_mss; ?>">
				...
				{ 
					...
					$text_project_manager = '';
					$bg_project_manager = '';
					if($consent_info[$t]->project_manager =='' && ($consent_info[$t]->unconditional_date !='0000-00-00' or $consent_info[$t]->date_issued != '0000-00-00')){
						$text_project_manager = "REQ";
                        $bg_project_manager = 'background-color:red; color:white'; 
					}else{
						$text_project_manager = $consent_info[$t]->project_manager;
                        $bg_project_manager = ''; 
					}

				?>
				<td class="close" id="23_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_project_manager; ?>">
					<?php echo $text_project_manager; ?>	
				</td>
				<?php 	} ?>
				...
				{ 
				?>
				<td class="close" id="25_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->unconditional_date != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
				...
				<?php 	
					...
					{ 
				?>
				<td class="close" id="26_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->handover_date != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
				...
				if($nuser_permission_type[27]->display_type == 1)
				{
					$text_builder = '';
					$bg_builder = '';
					$twenty_days_after = date('Y-m-d', strtotime(' - 20 days'));
                   	if($consent_info[$t]->builder == '' && $consent_info[$t]->date_logged !='0000-00-00' && $consent_info[$t]->date_logged < $twenty_days_after){
						$text_builder = 'Need Builder';
						$bg_builder = 'background-color:red; color:white';	
					}else{
						$text_builder = $consent_info[$t]->builder;
						$bg_builder = '';
					}
	
				?>
				<td class="close" id="27_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_builder; ?>">
					<?php 	echo $text_builder; ?>	
				</td>
				<?php } ?>
				...
				<?php if($nuser_permission_type[67]->display_type == 1){ 
						...
						if($consent_info[$t]->for_sale_sign == '' && ($consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
							$text_for_sale_sign = "N/A";
							$bg_for_sale_sign = '';
				...
				<?php 	
					...
					{ 
						...
						if($consent_info[$t]->title_date !='0000-00-00'){
							$bg_title_date = 'background-color:#90ee90; color:black';
						}else{
				...
				?>
				<td class="close" id="35_col_<?php echo $consent_info[$t]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_info[$t]->settlement_date != '0000-00-00'){ ?> background-color:orange; color:black; <?php } ?>">
					<?php 
							if($consent_info[$t]->settlement_date != '0000-00-00'){ 
								echo $this->wbs_helper->to_report_date($consent_info[$t]->settlement_date);
							} 
					 ?>
				</td>
				<?php 	} ?>
				...
				<?php 
						...
						{  
						  ...
						  ?>
							<tr id="consent_<?php echo $consent_info[$t]->month_id.'_'.$consent_child[$c]->id; ?>" class="child_<?php echo $consent_info[$t]->id; ?>" style="display:none;" onclick="selectrow(this.id,this.className);  ">
								<td id="job_<?php echo $month_id; ?>_<?php echo $n; ?>" class="child_td" style="width:74px;height:45px; background-color:white"><span id="jobnumber"><?php echo $consent_child[$c]->job_no;  ?></span></td>
								<?php if($nuser_permission_type[1]->display_type == 1){ 
									$bg_consent_name = '';
									if($consent_child[$c]->unconditional_date != '0000-00-00'){
										$bg_consent_name = "background-color:white;color:red;";
									}else if($consent_child[$c]->consent_color=='72D660'){ 
										$bg_consent_name = 'background-color:#90ee90'; }
									else{ 
										$bg_consent_name = 'background-color:#'.$consent_child[$t]->consent_color;
									} 
								?>
								<td id="0_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_consent_name; ?>"> 
									<?php echo $consent_child[$c]->consent_name;  ?>
								</td>
								<?php } if($nuser_permission_type[45]->display_type == 1){ 
									$bg_pre_construction_sign = "";
									if($consent_child[$c]->pre_construction_sign ==  ''){ 
										$bg_pre_construction_sign = "";
									}elseif($consent_child[$c]->pre_construction_sign ==  'REQ'){ 
										$bg_pre_construction_sign = "background-color:red; color:white";
									}elseif($consent_child[$c]->pre_construction_sign == "N/A"){
										$bg_pre_construction_sign = "background-color:#90ee90;color:black";
									}elseif($consent_child[$c]->pre_construction_sign ==''){
										$bg_pre_construction_sign = "background-color:white;";
									}else{
										$bg_pre_construction_sign = "background-color:#90ee90;color:black";
									}
								?>
								<td id="45_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo bg_pre_construction_sign; ?>">
									<?php echo $consent_child[$c]->pre_construction_sign;  ?>
								</td>
								<?php } if($nuser_permission_type[1]->display_type == 1){ 
										$text_design = '';
										$bg_design = '';
										
										if($consent_child[$c]->contract_type=='BC'){
											$text_design = 'Allocate';
											$bg_design = 'background-color:#90ee90;color:black';
										}elseif($consent_child[$c]->unconditional_date != '0000-00-00' && $consent_child[$c]->design_approval_date != '0000-00-00'){
											$text_design = 'REQ Brief';
											$bg_design = 'background-color:yellow;color:black';
										}elseif($consent_child[$c]->unconditional_date == '0000-00-00' && $consent_child[$c]->design_approval_date != '0000-00-00'){
											$text_design = 'Sign';
											...
											$text_design = 'Allo';
										}elseif($consent_child[$c]->drafting_issue_date != '0000-00-00'){
											$text_design = 'Consent';
											$bg_design = 'background-color:#90ee90';
										}elseif($consent_child[$c]->design =='REQ Brief'){
											$text_design = 'REQ Brief';
											$bg_design = 'background-color:yellow;color:black';
										}elseif($consent_child[$c]->design =='Hold'){
											$text_design = 'Hold';
											$bg_design = 'background-color:red;color:white;';
										}elseif($consent_child[$c]->design =='Brief'){
											$text_design = 'Brief';
											$bg_design = 'background-color:blue;color:white;';
										}elseif($consent_child[$c]->design =='Sign'){
											$text_design = 'Sign';
											$bg_design = 'background-color:orange;color:black';
										}elseif($consent_child[$c]->design =='Consent'){
											$text_design = 'Consent';
											$bg_design = 'background-color:#90ee90';
										}
								?>
								<td id="1_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_design; ?>">
									<?php echo $text_design;  ?>
								</td>
								<?php } if($nuser_permission_type[46]->display_type == 1){ ?>
								<td id="46_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->designer;  ?>
								</td>
								<?php } if($nuser_permission_type[2]->display_type == 1){ 
									$bg_design_approval_date = '';
									if($consent_child[$c]->design_approval_date != '0000-00-00'){
										$bg_design_approval_date = 'background-color:#90ee90;color:black;';
									}
								?>
								<td id="2_col_<?php echo $consent_child[$c]->job_no; ?>"  class="child close" style="width:145px;height:45px;<?php echo $bg_design_approval_date; ?>">
									<?php if($consent_child[$c]->design_approval_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->design_approval_date); }  ?>
								</td>
								<?php } if($nuser_permission_type[47]->display_type == 1){ 
										$text_ok_to_release_to_marketing = '';
										$bg_ok_to_release_to_marketing = '';
				
										if($consent_child[$c]->ok_to_release_to_marketing == '' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
											$text_ok_to_release_to_marketing = 'N/A';
											$bg_ok_to_release_to_marketing = '';
										}elseif($consent_child[$c]->ok_to_release_to_marketing == "Yes"){
											$text_ok_to_release_to_marketing = 'Yes';
											$bg_ok_to_release_to_marketing = 'background-color:#90ee90;color:black;';
										}elseif($consent_child[$c]->ok_to_release_to_marketing == "No"){
											$text_ok_to_release_to_marketing = 'No';
											$bg_ok_to_release_to_marketing = 'background-color:red;color:white;';
										}
								?>
								<td id="47_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_ok_to_release_to_marketing;  ?>">
									<?php 	echo $text_ok_to_release_to_marketing; ?> 
								</td>
								<?php } if($nuser_permission_type[48]->display_type == 1){ 
										$text_pricing_requested = '';
										$bg_pricing_requested = '';
										$twenty_days_before = date('Y-m-d', strtotime('-20 days'));
										if($consent_child[$c]->pricing_requested == '0000-00-00' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
											$text_pricing_requested = 'N/A';
											$bg_pricing_requested = '';
										}elseif($consent_child[$c]->design_approval_date!='0000-00-00' && $consent_child[$c]->contract_type == 'HL' && $consent_child[$c]->design_approval_date > $twenty_days_before && $consent_child[$c]->pricing_requested =='0000-00-00'){
											$text_pricing_requested = "REQ";
											$bg_pricing_requested = 'background-color:red;color:white;';
											//$ci->consent_model->send_consent_mail($consent_child[$c]->id,'pricing_requested',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);	
										}elseif($consent_child[$c]->design_approval_date < $twenty_days_before && $consent_child[$c]->design_approval_date!='0000-00-00' && $consent_child[$c]->pricing_requested =='0000-00-00'){
											$text_pricing_requested = "OVERDUE";
											$bg_pricing_requested = 'background-color:red;color:white;';
										}elseif($consent_child[$c]->pricing_requested == '0000-00-00'){
											$text_pricing_requested = "";
										}
										else{
											$bg_pricing_requested = 'background-color:#90ee90;color:black;';
											$text_pricing_requested = $this->wbs_helper->to_report_date($consent_child[$c]->pricing_requested); 
										}
								?>
								<td id="48_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_pricing_requested; ?>">
									<?php echo $text_pricing_requested;  ?>
								</td>
								...
								<?php } if($nuser_permission_type[49]->display_type == 1){ 
									...
									$bg_pricing_for_approval = '';
									$five_days_before = date('Y-m-d', strtotime('-5 days'));
									if($consent_child[$c]->pricing_for_approval == '0000-00-00' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
										$text_pricing_for_approval = 'N/A';
										$bg_pricing_for_approval = '';
									}elseif($consent_child[$c]->design_approval_date!='0000-00-00' && $consent_child[$c]->contract_type == 'HL' && $consent_child[$c]->pricing_requested =='0000-00-00' && $consent_child[$c]->pricing_for_approval=='0000-00-00' ){
										$text_pricing_for_approval = "DUE";
										$bg_pricing_for_approval = "background-color:orange; color:black";
									}elseif($consent_child[$c]->pricing_requested < $five_days_before && $consent_child[$c]->pricing_requested !='0000-00-00' && $consent_child[$c]->pricing_for_approval=='0000-00-00'  ){
										$text_pricing_for_approval = "OVERDUE";
										$bg_pricing_for_approval = 'background-color:red;color:white;';
									}elseif($consent_child[$c]->pricing_for_approval == '0000-00-00'){
										$text_pricing_for_approval = "";
									}else{
										$text_pricing_for_approval = $this->wbs_helper->to_report_date($consent_child[$c]->pricing_for_approval);
										$bg_pricing_for_approval = 'background-color:#90ee90;color:black;'; 
									}
								
								?>
								<td id="49_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_pricing_for_approval; ?>">
									<?php echo $text_pricing_for_approval;  ?>
								</td>
								<?php } if($nuser_permission_type[33]->display_type == 1){ 
										$txt_price_approved_date = '';
										$bg_price_approved_date = '';
										
										if($consent_child[$c]->price_approved_date == '0000-00-00' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){
											$txt_price_approved_date = 'N/A';
											$bg_price_approved_date = '';
										}elseif($consent_child[$c]->price_approved_date != '0000-00-00'){
											$txt_price_approved_date = $this->wbs_helper->to_report_date($consent_child[$c]->price_approved_date);
											$bg_price_approved_date = 'background-color:#90ee90; color:black;';
										}
								?>
								<td id="37_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_price_approved_date; ?>">
									<?php echo $txt_price_approved_date; ?>
								</td>
								<?php } if($nuser_permission_type[50]->display_type == 1){ ?>
								<td id="50_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->approved_for_sale_price;  ?>
								</td>
								<?php } if($nuser_permission_type[51]->display_type == 1){ 
									$text_kitchen_disign_type = '';
									$bg_kitchen_disign_type = '';

									if($consent_child[$c]->kitchen_disign_type == '' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){		
										$text_kitchen_disign_type = 'N/A';						
										$bg_kitchen_disign_type = '';
									}elseif($consent_child[$c]->kitchen_disign_type != ''){	
										$text_kitchen_disign_type = $consent_child[$c]->kitchen_disign_type;
										$bg_kitchen_disign_type = 'background-color:#90ee90; color:black;';
									}
									

									if($consent_child[$c]->kitchen_disign_type == "STD"){
												$ci->consent_model->send_consent_mail($consent_child[$c]->id,'kitchen_disign_type_std',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);	
									}
									if($consent_child[$c]->kitchen_disign_type == "DESIGNER"){
											$ci->consent_model->send_consent_mail($consent_child[$c]->id,'kitchen_disign_type_designer',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);	
									}
								?>
								<td id="51_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_kitchen_disign_type; ?>">
									<?php echo $text_kitchen_disign_type;   ?>
								</td>
								<?php } if($nuser_permission_type[52]->display_type == 1){ 
									...
									$bg_kitchen_disign_requested = '';
									$twenty_days_before = date('Y-m-d', strtotime('+20 days'));
									$pricing_for_approval_date = $this->wbs_helper->change_cms_date($consent_child[$c]->pricing_for_approval);

									if($consent_child[$c]->kitchen_disign_requested == '' && ( $consent_child[$c]->contract_type == 'EQ' or $consent_child[$c]->contract_type == 'BC')){		
										$text_kitchen_disign_requested = 'N/A';						
										$bg_kitchen_disign_requested = '';
									}elseif( $consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $consent_child[$c]->pricing_for_approval !='0000-00-00' && $twenty_days_before < $consent_child[$c]->design_approval_date){
										$text_kitchen_disign_requested = "REQ";
										$bg_kitchen_disign_requested = "background-color:red;color:white;";
										$ci->consent_model->send_consent_mail($consent_child[$c]->id,'kitchen_disign_requested',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);	
									}elseif($twenty_days_before > $consent_child[$c]->design_approval_date && $consent_child[$c]->design_approval_date !='0000-00-00' ){
										$text_kitchen_disign_requested = "OVERDUE"; 
										$bg_kitchen_disign_requested = "background-color:red;color:white;";
									}elseif($consent_child[$c]->kitchen_disign_requested == ''){
										$text_kitchen_disign_requested = '';
									}else{
										$text_kitchen_disign_requested = $consent_child[$c]->kitchen_disign_requested;
									}
								?>
								<td id="52_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_kitchen_disign_requested;  ?>">
									<?php echo $text_kitchen_disign_requested ;  ?>
								</td>
								<?php } if($nuser_permission_type[53]->display_type == 1){ 
									$text_colours_requested_and_loaded_on_gc = '';
									$bg_colours_requested_and_loaded_on_gc = '';
									...
									if( $consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $consent_child[$c]->pricing_for_approval !='0000-00-00' && $consent_child[$c]->colours_requested_and_loaded_on_gc == '0000-00-00' && $twenty_days_before < $consent_child[$c]->design_approval_date){
										$text_colours_requested_and_loaded_on_gc = "REQ";
										$bg_colours_requested_and_loaded_on_gc = "background-color:red;color:white;";
										$ci->consent_model->send_consent_mail($consent_child[$c]->id,'colours_requested_and_loaded_on_gc',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);	
									}
									elseif($twenty_days_before > $consent_child[$c]->design_approval_date && $consent_child[$c]->design_approval_date != '0000-00-00' ){
										$text_colours_requested_and_loaded_on_gc = "OVERDUE"; 
										$bg_colours_requested_and_loaded_on_gc = "background-color:red;color:white;";
									}elseif($consent_child[$c]->colours_requested_and_loaded_on_gc=='0000-00-00'){
										$text_colours_requested_and_loaded_on_gc = '';
									}else{
										$text_colours_requested_and_loaded_on_gc = $this->wbs_helper->to_report_date($consent_child[$c]->colours_requested_and_loaded_on_gc);
										$bg_colours_requested_and_loaded_on_gc = "background-color:#90ee90;color:black;";
									}
								
								?>
								<td id="53_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_colours_requested_and_loaded_on_gc;?>">
									<?php echo $text_colours_requested_and_loaded_on_gc;  ?>
								</td>
								<?php } if($nuser_permission_type[54]->display_type == 1){ 
								
									$text_kitchen_design_loaded_on_gc = '';
									$bg_kitchen_design_loaded_on_gc = '';
									if($consent_child[$c]->kitchen_disign_requested == 'REQ' OR($consent_child[$c]->ok_to_release_to_marketing == 'Yes' && $twenty_days_before < $consent_child[$c]->design_approval_date)){
										$text_kitchen_design_loaded_on_gc = "REQ";
										$bg_kitchen_design_loaded_on_gc = "background-color:red;color:white;";
									}else{
										$text_kitchen_design_loaded_on_gc = $consent_child[$c]->kitchen_design_loaded_on_gc; 
									}
									
								?>
								<td class="close" id="54_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_kitchen_design_loaded_on_gc;  ?>">	
									<?php 	
										echo $text_kitchen_design_loaded_on_gc;
									?>		
								</td>
								...
								<?php if($nuser_permission_type[55]->display_type == 1){ 
										...
										if( $consent_child[$c]->colours_requested_and_loaded_on_gc != '0000-00-00' && $consent_child[$c]->colours_requested_and_loaded_on_gc > $ten_days_before  && $consent_child[$c]->developer_colour_sheet_created == '0000-00-00' ){
											$text_developer_colour_sheet_created = "REQ";
											$bg_developer_colour_sheet_created = "background-color:red;color:white;";
											
										}elseif($consent_child[$c]->colours_requested_and_loaded_on_gc < $ten_days_before && $consent_child[$c]->colours_requested_and_loaded_on_gc!='0000-00-00'  && $consent_child[$c]->developer_colour_sheet_created == '0000-00-00' ){
											$text_developer_colour_sheet_created = "OVERDUE";
											$bg_developer_colour_sheet_created = "background-color:red;color:white;";
										}elseif($consent_child[$c]->developer_colour_sheet_created == '0000-00-00'){
											$text_developer_colour_sheet_created = "";
										}else{
											$text_developer_colour_sheet_created = $this->wbs_helper->to_report_date($consent_child[$c]->developer_colour_sheet_created); 
											$bg_developer_colour_sheet_created = "background-color:#90ee90;color:black;";
										}


								?>
								<td class="close" id="55_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_developer_colour_sheet_created; ?>">	
									<?php 	
										echo $text_developer_colour_sheet_created;
									?> 		
								</td>
								...
								<?php if($nuser_permission_type[56]->display_type == 1){ 
									...
									$twenty_days_before = date('Y-m-d', strtotime('-20 days'));
									if($consent_child[$c]->price_approved_date!='0000-00-00'){
										if($consent_child[$c]->contract_type == 'HL' & $consent_child[$c]->price_approved_date > $twenty_days_before){
											$text_spec_loaded_on_gc = "REQ";
											$bg_spec_loaded_on_gc = "background-color:red;color:white;";
										}
										elseif($consent_child[$c]->price_approved_date < $twenty_days_before ){
												$text_spec_loaded_on_gc = "OVERDUE";
												$bg_spec_loaded_on_gc = "background-color:red;color:white;";
										}	
									}else{
										$text_spec_loaded_on_gc = $consent_child[$c]->spec_loaded_on_gc; 
									}

									

								?>
								<td class="close" id="56_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_spec_loaded_on_gc;  ?>">	
									<?php 
										echo $text_spec_loaded_on_gc;
									?>		
								</td>
								...
								<?php if($nuser_permission_type[57]->display_type == 1){ 
										...
										$ten_days_before = date('Y-m-d', strtotime('-10 days'));
										if($consent_child[$c]->price_approved_date!='0000-00-00'){
											if( $ten_days_before > $consent_child[$c]->price_approved_date){
												$text_loaded_on_intranet = "OVERDUE";
												$bg_loaded_on_intranet = "background-color:red;color:white;";
											}else{
												$text_loaded_on_intranet = "REQ";
											...
											$text_loaded_on_intranet = $consent_child[$c]->loaded_on_intranet; 

										}
								?>
								<td class="close" id="57_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_loaded_on_intranet; ?>">	
									<?php 	
										echo $text_loaded_on_intranet;
									?>		
								</td>
								...
								<?php if($nuser_permission_type[58]->display_type == 1){ 
										...
										if($consent_child[$c]->price_approved_date!='0000-00-00'){
											...
											$text_website = $consent_child[$c]->website; 
										}


								?>
								<td class="close" id="58_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_website;  ?>">	
									<?php 
										echo $text_website;
									?>	
								</td>
								...
								<?php if($nuser_permission_type[59]->display_type == 1){ 
										...
										if($consent_child[$c]->colours_requested_and_loaded_on_gc != '0000-00-00'  && $consent_child[$c]->render_requested == '0000-00-00' ){ 
											$text_render_requested = "REQ";	
											$bg_render_requested = "background-color:red;color:white;";
										}elseif($consent_child[$c]->render_requested == '0000-00-00'){
											$text_render_requested = '';
										}else{
											$bg_render_requested = "background-color:#90ee90;color:black;";
											$text_render_requested = $this->wbs_helper->to_report_date($consent_child[$c]->render_requested); 
										}
								?>
								<td class="close" id="59_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_render_requested; ?>">	
									<?php
										echo $text_render_requested;	
									?>	
								</td>
								...
								<?php if($nuser_permission_type[60]->display_type == 1){ 
										...
										if( $twenty_days_before > $consent_child[$c]->render_requested && $consent_child[$c]->render_requested != '0000-00-00' && $consent_child[$c]->render_received == '0000-00-00'){
											$text_render_received = "OVERDUE";
											$bg_render_received = "background-color:red;color:white;";
										}elseif($twenty_days_before < $consent_child[$c]->render_requested && $consent_child[$c]->render_requested != '0000-00-00' && $consent_child[$c]->render_received == '0000-00-00'){
											$text_render_received =  "REQ";
											$bg_render_received = "background-color:red;color:white;";
										}elseif($consent_child[$c]->render_received == '0000-00-00'){
											$text_render_received =  "";
										}else{
											$text_render_received = $this->wbs_helper->to_report_date($consent_child[$c]->render_received); 
											$bg_render_received = "background-color:#90ee90;color:black;";
										}


								?>
								<td class="close" id="60_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_render_received; ?>">	
									<?php 	
										echo $text_render_received; 
									?> 		
								</td>
								...
								<?php if($nuser_permission_type[61]->display_type == 1){ 
										...
										if( $ten_days_before > $consent_child[$c]->render_received && $consent_child[$c]->render_received != '0000-00-00'){
											$text_brochure = "OVERDUE";
											$bg_brochure = "background-color:red;color:white;";
										}elseif($ten_days_before < $consent_child[$c]->render_received && $consent_child[$c]->render_received != '0000-00-00'){
											$text_brochure = "REQ";
											$bg_brochure = "background-color:red;color:white;";
										}else{
											$text_brochure = $consent_child[$c]->brochure; 
										}

								?>
								<td class="close" id="61_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_brochure; ?>">	
									<?php 	
										echo $text_brochure;	
									?> 		
								</td>
								...
								<?php 	
									if($nuser_permission_type[3]->display_type == 1){ 
								?>
								<td class="close" id="3_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->pim_logged != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->pim_logged); } ?>
								</td>
								<?php 	} ?>
								...
								if($nuser_permission_type[6]->display_type == 1){ 
								?>
								<td class="close" id="6_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->drafting_issue_date != '0000-00-00'){ ?> background-color:#90ee90; color:black; <?php } ?>">
									<?php if($consent_child[$c]->drafting_issue_date != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->drafting_issue_date); } ?>
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="7_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php 	echo $consent_child[$c]->consent_by; ?>
								</td>
								<?php 	} ?>
								...
								<?php 	
									if($nuser_permission_type[8]->display_type == 1)
											{ $txt = '';
								?>
								<td class="close" id="8_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px; background-color:
								<?php
									$fourteen_days_before = date('Y-m-d', strtotime('-14 days'));
									$thirty_days_before = date('Y-m-d', strtotime('-30 days'));
									$twenty_days_before = date('Y-m-d', strtotime('-20 days'));
									if( $consent_child[$c]->unconditional_date!='0000-00-00' && $consent_child[$c]->unconditional_date < $fourteen_days_before && $consent_child[$c]->drafting_issue_date == '0000-00-00'){echo "red; color:white;"; $txt = 'Issue For Consent'; }
									if( $consent_child[$c]->drafting_issue_date < $thirty_days_before && $consent_child[$c]->drafting_issue_date != '0000-00-00'){echo "red; color:white;"; $txt = 'Drawings Late'; }
									if( $consent_child[$c]->date_logged != '0000-00-00' && $consent_child[$c]->date_logged  < $twenty_days_before ){echo "red; color:white;"; $txt = 'Consent Late';}
								?>">	
								...
								{ 
								?>
								<td class="close" id="9_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->council; 

									if($consent_child[$c]->design_approval_date!='0000-00-00' && ( $consent_child[$c]->council == 'Chch' or $consent_child[$c]->council == 'Waimak' or $consent_child[$c]->council == 'Hurunui' or $consent_child[$c]->council == 'Ashburton')){
										$ci->consent_model->send_consent_mail($consent_child[$c]->id,'council_chch',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);
									}

									if($consent_child[$c]->design_approval_date!='0000-00-00' && ($consent_child[$c]->council == 'Auckland' or $consent_child[$c]->council == 'Waikato')){
										$ci->consent_model->send_consent_mail($consent_child[$c]->id,'council_auc',$consent_child[$c]->job_no,$consent_child[$c]->consent_name,$consent_child[$c]->council);
									}
								...
								if($nuser_permission_type[29]->display_type == 1)
								{ ?>
								<td class="close" id="29_col_<?php echo $consent_child[$c]->job_no; ?>"style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->lbp; ?>				
								</td>
								<?php } ?>
								...
								<?php 	
									...
									{ 
								?>
								<td class="close" id="30_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->date_job_checked != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_job_checked); } ?>
								</td>
								<?php 	} ?>
								...
								{ 	
								?>
								<td class="close" id="10_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php 	echo $consent_child[$c]->bc_number; ?>
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="11_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php echo $unit_number; 	//echo $consent_child[$c]->no_units; ?> 					
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="12_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->contract_type; ?> 
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="13_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->type_of_build; ?>		
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="14_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->variation_pending=='Yes'){ ?>background-color:red; color:white;<?php } ?>">
									<?php 	echo $consent_child[$c]->variation_pending; ?>
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="15_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->foundation_type; ?>
								</td>
								<?php 	} ?>

								<?php if($nuser_permission_type[62]->display_type == 1){ ?>
								<td class="close" id="62_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php 	echo $consent_child[$c]->resource_consent; ?> 		
								</td>
								<?php 	} ?>
								
								<?php if($nuser_permission_type[63]->display_type == 1){ ?>
								<td class="close" id="63_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php 	echo $consent_child[$c]->rc_number; ?>
								</td>
								<?php 	} ?>
								
								<?php if($nuser_permission_type[64]->display_type == 1){ ?>
								<td class="close" id="64_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php if($consent_child[$c]->expected_date_to_lodge_bc != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->expected_date_to_lodge_bc); } ?>		
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="16_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->date_logged != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
									<?php 	if($consent_child[$c]->date_logged != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_logged); } ?>
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="17_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->date_issued != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
									<?php 	if($consent_child[$c]->date_issued != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_issued); } ?>		
								</td>
								<?php 	} ?>
								...
								<?php 	
									...
									{ 
								?>
								<td class="close" id="18_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">
									<?php 	if($consent_child[$c]->actual_date_issued != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->actual_date_issued); } ?>		
								</td>
								<?php 	} ?>
								...
								<td class="close" style="width:145px;height:45px;">
									<?php
									if($consent_child[$c]->date_logged != '0000-00-00' && $consent_child[$c]->date_issued != '0000-00-00'){ echo $days_in_council = $ci->consent_model->get_working_days($consent_child[$c]->date_logged, $consent_child[$c]->date_issued) - 1; }else if($consent_child[$c]->date_logged != '0000-00-00' && $consent_child[$c]->date_issued == '0000-00-00'){ echo $days_in_council = $ci->consent_model->get_working_days($consent_child[$c]->date_logged, date('Y-m-d')) - 1; }else{ echo '0'; }
								...
								<?php if($nuser_permission_type[65]->display_type == 1){ ?>
								<td class="close" id="65_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php 	echo $consent_child[$c]->water_connection; ?>		
								</td>
								<?php 	} ?>
								...
								<?php if($nuser_permission_type[66]->display_type == 1){ 
									...
									if($consent_child[$c]->vehicle_crossing == '' && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_vehicle_crossing = "REQ";
										$bg_vehicle_crossing = 'background-color:red; color:white';
									}else{
										$text_vehicle_crossing = $consent_child[$c]->vehicle_crossing;
										$bg_vehicle_crossing = 'color:black';
									}
								?>
								<td class="close" id="66_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_vehicle_crossing; ?>">	
									<?php 	echo $text_vehicle_crossing ; ?>		
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if($consent_child[$c]->order_site_levels == '' && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_order_site_levels = "REQ";
										$bg_order_site_levels = 'background-color:red; color:white';
									}elseif($consent_child[$c]->order_site_levels == 'Received'){
										$text_order_site_levels = "Received";
										$bg_order_site_levels = 'background-color:#90ee90; color:black';
									}elseif($consent_child[$c]->order_site_levels == 'Sent'){
										$text_order_site_levels = "Sent";
										$bg_order_site_levels = 'background-color:blue; color:white';
									}elseif($consent_child[$c]->order_site_levels == 'N/A'){
										$text_order_site_levels = "N/A";
										$bg_order_site_levels = 'background-color:white; color:black';
									}
								?>
								<td class="close" id="19_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_order_site_levels; ?>">
								<?php 
									echo $text_order_site_levels;
								?>
								</td>
								...
								{ 
									...
									if($consent_child[$c]->order_soil_report == '' && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_order_soil_report = "REQ";
										$bg_order_soil_report = 'background-color:red; color:white';
									}elseif($consent_child[$c]->order_soil_report == 'Received'){
										$text_order_soil_report = "Received";
										$bg_order_soil_report = 'background-color:#90ee90;color:black';
									}elseif($consent_child[$c]->order_soil_report == 'Sent'){
										$text_order_soil_report = "Sent";
										$bg_order_soil_report = 'background-color:blue; color:white';
									}elseif($consent_child[$c]->order_soil_report == 'N/A'){
										$text_order_soil_report = "N/A";
										$bg_order_soil_report = 'background-color:white; color:black';
									}

								?>
								<td class="close" id="20_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_order_soil_report; ?>">
									<?php echo $text_order_soil_report; ?>
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if($consent_child[$c]->septic_tank_approval == '' && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_septic_tank_approval = "REQ";
										$bg_septic_tank_approval = 'background-color:red; color:white';
									}elseif($consent_child[$c]->septic_tank_approval == 'RECEIVED'){
										$text_septic_tank_approval = "Received";
										$bg_septic_tank_approval = 'background-color:#90ee90;color:black';
									}elseif($consent_child[$c]->septic_tank_approval == 'SENT'){
										$text_septic_tank_approval = "SENT";
										$bg_septic_tank_approval = 'background-color:blue; color:white';
									}elseif($consent_child[$c]->septic_tank_approval == 'N/A'){
										$text_septic_tank_approval = "N/A";
										$bg_septic_tank_approval = 'background-color:white; color:black';
									}
								?>
								<td class="close" id="21_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;color:white;<?php echo $bg_septic_tank_approval; ?>">
									<?php echo $text_septic_tank_approval; ?>
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if($consent_child[$c]->drainage_testing == '' && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_drainage_testing = "REQ";
										$bg_drainage_testing = 'background-color:red; color:white';
									}elseif(trim($consent_child[$c]->drainage_testing) == ''){
										$text_drainage_testing = '';
										$bg_drainage_testing = '';
									}else{
										$text_drainage_testing = $consent_child[$c]->drainage_testing;
										$bg_drainage_testing = 'background-color:#90ee90;color:black';
									}
								?>
								<td class="close" id="70_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_drainage_testing; ?>">
									<?php echo $text_drainage_testing;  ?>
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if(($consent_child[$c]->dev_approval == '' or $consent_child[$c]->dev_approval == 'REQ') && ($consent_child[$c]->contract_type == 'HL' or $consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_dev_approval = "REQ";
										$bg_dev_approval = 'background-color:red; color:white';
									}elseif($consent_child[$c]->dev_approval == 'FULL SENT'){
										$text_dev_approval = "FULL SENT";
										$bg_dev_approval = 'background-color:blue; color:white';
									}elseif($consent_child[$c]->dev_approval == 'FULL REC'){
										$text_dev_approval = "FULL REC";
										$bg_dev_approval = 'background-color:#90ee90;color:black';
									}elseif($consent_child[$c]->dev_approval == 'N/A'){
										$text_dev_approval = "N/A";
										$bg_dev_approval = 'background-color:white; color:black';
									}elseif($consent_child[$c]->dev_approval == 'PRE SENT'){
										$text_dev_approval = "PRE SENT";
										$bg_dev_approval = 'background-color:yellow; color:black';
									}elseif($consent_child[$c]->dev_approval == ''){
										$text_dev_approval = "";
										$bg_dev_approval = '';
									}elseif($consent_child[$c]->dev_approval == 'PRE REC'){
										$text_dev_approval = "PRE REC";
										$bg_dev_approval = 'background-color:yellow; color:black;';
									}
								?>
								<td class="close" id="22_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_dev_approval; ?>">
									<?php echo $text_dev_approval; ?>
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if(($consent_child[$c]->landscape == '' or $consent_child[$c]->landscape == 'REQ') && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_landscape = "REQ";
										$bg_landscape = 'background-color:red; color:white';
									}elseif($consent_child[$c]->landscape == 'RECEIVED'){
										$text_landscape = "Received";
										$bg_landscape = 'background-color:#90ee90;color:black';
									}elseif($consent_child[$c]->landscape == 'SENT'){
										$text_landscape = "SENT";
										$bg_landscape = 'background-color:blue; color:white';
									}elseif($consent_child[$c]->landscape == 'N/A'){
										$text_landscape = "N/A";
										$bg_landscape = 'background-color:white; color:black';
									}

								?>
								<td class="close" id="32_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_landscape;  ?>">
									<?php echo $text_landscape; ?>
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if($consent_child[$c]->mss == '' && $consent_child[$c]->drafting_issue_date !='0000-00-00'){
										$text_mss = 'REQ';
										$bg_mss = 'background-color:red; color:white';
									}elseif($consent_child[$c]->mss == 'REQ'){
										$text_mss = 'REQ';
										$bg_mss = 'background-color:red; color:white';
									}elseif($consent_child[$c]->mss == 'DONE'){
										$text_mss = 'DONE';
										$bg_mss = 'background-color:#90ee90;color:black';
									}

								?>
								<td class="close" id="33_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;color:white;<?php echo $bg_mss; ?>">
								...
								{ 
									...
									$text_project_manager = '';
									$bg_project_manager = '';
									if($consent_child[$c]->project_manager =='' && ($consent_child[$c]->unconditional_date !='0000-00-00' or $consent_child[$c]->date_issued != '0000-00-00')){
										$text_project_manager = "REQ";
										$bg_project_manager = 'background-color:red; color:white'; 
									}else{
										$text_project_manager = $consent_child[$c]->project_manager;
										$bg_project_manager = ''; 
									}

								?>
								<td class="close" id="23_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_project_manager; ?>">
									<?php echo $text_project_manager; ?>	
								</td>
								<?php 	} ?>
								...
								{ 
								?>
								<td class="close" id="25_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->unconditional_date != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
									<?php 	if($consent_child[$c]->unconditional_date != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->unconditional_date); } ?>	
								</td>
								<?php 	} ?>
								...
								<?php 	
									...
									{ 
								?>
								<td class="close" id="26_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->handover_date != '0000-00-00'){ ?> background-color:#90ee90;color:black; <?php } ?>">
									<?php if($consent_child[$c]->handover_date != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->handover_date); } ?>
								</td>
								<?php 	} ?>
								...
								if($nuser_permission_type[27]->display_type == 1)
								{
									...
									$bg_builder = '';
									$twenty_days_after = date('Y-m-d', strtotime(' - 20 days'));
									if($consent_child[$c]->builder == '' && $consent_child[$c]->date_logged !='0000-00-00' && $consent_child[$c]->date_logged < $twenty_days_after){
										$text_builder = 'Need Builder';
										$bg_builder = 'background-color:red; color:white';	
									}else{
										$text_builder = $consent_child[$c]->builder;
										$bg_builder = '';
									}
					
								?>
								<td class="close" id="27_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_builder; ?>">
									<?php 	echo $text_builder; ?>	
								</td>
								<?php } ?>
								...
								<?php if($nuser_permission_type[67]->display_type == 1){ 
										...
										if( $ten_days_before > $consent_child[$c]->render_received && $consent_child[$c]->render_received !='0000-00-00' && $consent_child[$c]->for_sale_sign == ''){
											$text_for_sale_sign = "OVERDUE";
											$bg_for_sale_sign = "background-color:red; color:white";
										}elseif($ten_days_before < $consent_child[$c]->render_received && $consent_child[$c]->render_received !='0000-00-00' && $consent_child[$c]->for_sale_sign == ''){
											$text_for_sale_sign = "REQ";
											$bg_for_sale_sign = "background-color:red; color:white";
										}else{
											$text_for_sale_sign = $consent_child[$c]->for_sale_sign; 
										}


								?>
								<td class="close" id="67_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_for_sale_sign; ?>">	
									<?php 
										echo $text_for_sale_sign;
									?>		
								</td>
								...
								<?php if($nuser_permission_type[68]->display_type == 1){ ?>
								<td class="close" id="68_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php 	echo $consent_child[$c]->code_of_compliance; ?>		
								</td>
								<?php 	} ?>
								...
								<?php 	
									...
									{ 
										$bg_title_date = '';
										if($consent_child[$c]->title_date !='0000-00-00'){
											$bg_title_date = 'background-color:#90ee90; color:black';
										}else{
											$bg_title_date = 'background-color:#ffffff; color:black';
										}
								?>
								<td class="close" id="34_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php echo $bg_title_date; ?>">
									<?php if($consent_child[$c]->title_date != '0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->title_date); } ?>
								</td>
								<?php 	} ?>
								...
								<?php 	
									...
									{ 
								?>
								<td class="close" id="35_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;<?php if($consent_child[$c]->settlement_date != '0'){ ?> background-color:orange; color:black; <?php } ?>">
									<?php 
											if($consent_child[$c]->title_date != '0000-00-00'){ 
												$settlement_date = strtotime($consent_child[$c]->title_date) + ($consent_child[$c]->settlement_date * 24 * 60 * 60);
								...
								<?php if($nuser_permission_type[69]->display_type == 1){ 
										...
										if($consent_child[$c]->handover_date != '0000-00-00'){ 
											$text_photos_taken = "REQ"; 
											$bg_photos_taken = "background-color:red; color:white";
										}else{ 
											$text_photos_taken = $consent_child[$c]->photos_taken; 
										} 

								?>
								<td class="close" id="69_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_photos_taken; ?>">	
									<?php 
										echo $text_photos_taken;
									?>		
								</td>
								<?php } if($nuser_permission_type[36]->display_type == 1){ ?>
								<td id="36_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;color:blue;">
									<p title="<?php echo $consent_child[$c]->notes; ?>" class="masterTooltip"><?php if($consent_child[$c]->notes!=''){ echo substr($consent_child[$c]->notes,0,40)."...."; } ?></p>
								</td>
								<?php } ?>
							</tr>
					...
					if($n == 0)
					{ // this row is for drag a row to blank table
...
$(document).ready(function() {
	...
	$('.ui-multiselect-all').click(function(){
		...
		$("#refine_colunm_name").append('<div class="colunm3" id="design"><span>Refine Design:</span><br><select id="search_value_select" name="design_search_value"><option value="">-- Select --</option><option value="REQ Brief">REQ Brief</option><option value="Brief">Brief</option><option value="Hold">Hold</option><option value="Sign">Sign</option><option value="Allo">Allo</option><option value="Consent">Consent</option></select></div>');
