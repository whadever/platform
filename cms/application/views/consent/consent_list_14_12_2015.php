		...
		<?php
			...
			<tbody id="<?php echo $month_id; ?>" class="tbody<?php echo $p; ?> connectedSortable">
				...
				if($nuser_permission_type[1]->display_type == 1)
				{
					...
					}else if($consent_info[$t]->consent_color=='72D660'){ 
				...
				{ 
					...
					if($consent_info[$t]->contract_type=='BC'){
					...
					}elseif($consent_info[$t]->design =='Sign'){
						$text_design = 'Sign';
						$bg_design = 'background-color:orange;color:black';
					}elseif($consent_info[$t]->design =='Consent'){
						$text_design = 'Consent';
						$bg_design = 'background-color:#90ee90;color:';
					}
				...
				{ 
					...
					if($consent_info[$t]->price_approved_date == '0000-00-00' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){
				...
				<?php if($nuser_permission_type[51]->display_type == 1){
					...
					if($consent_info[$t]->kitchen_disign_type == "STD"){
				...
				<?php if($nuser_permission_type[52]->display_type == 1){
					...
					if($consent_info[$t]->kitchen_disign_requested == '' && ( $consent_info[$t]->contract_type == 'EQ' or $consent_info[$t]->contract_type == 'BC')){		
						...
						$bg_kitchen_disign_requested = '';
					}elseif( $consent_info[$t]->ok_to_release_to_marketing == 'Yes' && $consent_info[$t]->pricing_for_approval !='0000-00-00' && $twenty_days_before < $consent_info[$t]->approval_date){
				...
				{ 
					...
					if($consent_info[$t]->drainage_testing == '' && ($consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
				...
				{ 
					...
					if(($consent_info[$t]->dev_approval == '' or $consent_info[$t]->dev_approval == 'REQ') && ($consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
				...
				{ 
					...
					if(($consent_info[$t]->landscape == '' or $consent_info[$t]->landscape == 'REQ') && ($consent_info[$t]->contract_type == 'BC' or $consent_info[$t]->contract_type == 'EQ') ){
						$text_landscape = "REQ";
						...
						{  
						  ...
						  ?>
							<tr id="consent_<?php echo $consent_info[$t]->month_id.'_'.$consent_child[$c]->id; ?>" class="child_<?php echo $consent_info[$t]->id; ?>" style="display:none;" onclick="selectrow(this.id,this.className);  ">
								...
								?>
								<td id="51_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
								...
								<?php if($nuser_permission_type[66]->display_type == 1){ ?>
								<td class="close" id="66_col_<?php echo $consent_child[$c]->job_no; ?>" style="width:145px;height:45px;">	
									<?php 	echo $consent_child[$c]->vehicle_crossing; ?>		
								</td>
								<?php 	} ?>
								...
								{ 
									...
									if($consent_child[$c]->order_site_levels == '' && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_order_site_levels = "REQ";
										$bg_order_site_levels = 'background-color:red; color:white';
								...
								{ 
									...
									if($consent_child[$c]->order_soil_report == '' && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_order_soil_report = "REQ";
										$bg_order_soil_report = 'background-color:red; color:white';
								...
								{ 
									...
									if($consent_child[$c]->septic_tank_approval == '' && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_septic_tank_approval = "REQ";
										$bg_septic_tank_approval = 'background-color:red; color:white';
								...
								{ 
									...
									if($consent_child[$c]->drainage_testing == '' && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_drainage_testing = "REQ";
										$bg_drainage_testing = 'background-color:red; color:white';
									}else{
								...
								{ 
									...
									if(($consent_child[$c]->dev_approval == '' or $consent_child[$c]->dev_approval == 'REQ') && ($consent_child[$c]->contract_type == 'BC' or $consent_child[$c]->contract_type == 'EQ') ){
										$text_dev_approval = "REQ";
										$bg_dev_approval = 'background-color:red; color:white';
