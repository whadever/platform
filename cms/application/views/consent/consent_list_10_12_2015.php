							...
							<tr id="consent_<?php echo $consent_info[$t]->month_id.'_'.$consent_child[$c]->id; ?>" class="child_<?php echo $consent_info[$t]->id; ?>" style="display:none;" onclick="selectrow(this.id,this.className);  ">
								...
								<?php } if($nuser_permission_type[45]->display_type == 1){ 
									...
									if($consent_child[$c]->pre_construction_sign ==  ''){ 
										...
										$bg_pre_construction_sign = "background-color:green; color:white";
								...
								<?php } if($nuser_permission_type[47]->display_type == 1){ ?>
								<td id="47_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->ok_to_release_to_marketing;  ?>
								</td>
								<?php } if($nuser_permission_type[48]->display_type == 1){ ?>
								<td id="48_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->pricing_requested;  ?>
								</td>
								<?php } if($nuser_permission_type[49]->display_type == 1){ ?>
								<td id="49_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->pricing_for_approval;  ?>
								</td>
								<?php } if($nuser_permission_type[33]->display_type == 1){ ?>
								<td id="37_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->price_approved_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->price_approved_date); } ?>
								</td>
								<?php } if($nuser_permission_type[50]->display_type == 1){ ?>
								...
								<td id="51_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->kitchen_disign_type;  ?>
								</td>
								<?php } if($nuser_permission_type[52]->display_type == 1){ ?>
								<td id="52_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->kitchen_disign_requested;  ?>
								</td>
								<?php } if($nuser_permission_type[53]->display_type == 1){ ?>
								<td id="53_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->colours_requested_and_loaded_on_gc;  ?>
								</td>
								<?php } if($nuser_permission_type[54]->display_type == 1){ ?>
								<td id="54_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->kitchen_design_loaded_on_gc;  ?>
								</td>
								<?php } if($nuser_permission_type[55]->display_type == 1){ ?>
								<td id="55_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->developer_colour_sheet_created;  ?>
								</td>
								<?php } if($nuser_permission_type[56]->display_type == 1){ ?>
								<td id="56_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->spec_loaded_on_gc;  ?>
								</td>
								<?php } if($nuser_permission_type[57]->display_type == 1){ ?>
								<td id="57_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->loaded_on_intranet;  ?>
								</td>
								<?php } if($nuser_permission_type[58]->display_type == 1){ ?>
								<td id="58_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->website;  ?>
								</td>
								<?php } if($nuser_permission_type[59]->display_type == 1){ ?>
								<td id="59_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->render_requested;  ?>
								</td>
								<?php } if($nuser_permission_type[60]->display_type == 1){ ?>
								<td id="60_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->render_received;  ?>
								</td>
								<?php } if($nuser_permission_type[61]->display_type == 1){ ?>
								<td id="61_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->brochure;  ?>
								</td>
								<?php } if($nuser_permission_type[3]->display_type == 1){ ?>
								<td id="3_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->pim_logged!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->pim_logged); } ?></td>
								<?php } if($nuser_permission_type[6]->display_type == 1){ ?>
								<td id="6_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->drafting_issue_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->drafting_issue_date); } ?></td>
								<?php } if($nuser_permission_type[7]->display_type == 1){ ?>
								<td id="7_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->consent_by;  ?></td>
								<?php } if($nuser_permission_type[8]->display_type == 1){ ?>
								<td id="8_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;"></td>
								<?php } if($nuser_permission_type[9]->display_type == 1){ ?>
								<td id="9_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->council;  ?></td>
								<?php } if($nuser_permission_type[29]->display_type == 1){ ?>
								<td id="29_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->lbp;  ?></td>
								<?php } if($nuser_permission_type[30]->display_type == 1){ ?>
								<td id="30_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->date_job_checked!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_job_checked); }  ?></td>
								<?php } if($nuser_permission_type[10]->display_type == 1){ ?>
								<td id="10_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->bc_number;  ?></td>
								<?php } if($nuser_permission_type[11]->display_type == 1){ ?>
								<td id="11_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo '1';  //$consent_child[$c]->no_units;  ?></td>
								<?php } if($nuser_permission_type[12]->display_type == 1){ ?>
								<td id="12_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->contract_type;  ?></td>
								<?php } if($nuser_permission_type[13]->display_type == 1){ ?>
								<td id="13_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->type_of_build;  ?></td>
								<?php } if($nuser_permission_type[14]->display_type == 1){ ?>
								<td id="14_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->variation_pending;  ?></td>
								<?php } if($nuser_permission_type[15]->display_type == 1){ ?>
								<td id="15_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->foundation_type;  ?></td>
								<?php } if($nuser_permission_type[62]->display_type == 1){ ?>
								<td id="62_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->resource_consent;  ?></td>
								<?php } if($nuser_permission_type[63]->display_type == 1){ ?>
								<td id="63_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->rc_number;  ?></td>
								<?php } if($nuser_permission_type[64]->display_type == 1){ ?>
								<td id="64_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
								...
								<?php } if($nuser_permission_type[16]->display_type == 1){ ?>
								<td id="16_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->date_logged!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_logged); } ?>
								</td>
								<?php } if($nuser_permission_type[17]->display_type == 1){ ?>
								<td id="17_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->date_issued!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->date_issued); } ?>
								</td>
								<?php } if($nuser_permission_type[18]->display_type == 1){ ?>
								<td id="18_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
								...
								<?php } if($nuser_permission_type[65]->display_type == 1){ ?>
								<td id="65_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->water_connection;  ?>
								</td>
								<?php } if($nuser_permission_type[66]->display_type == 1){ ?>
								<td id="66_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->vehicle_crossing;  ?>
								</td>
								<?php } if($nuser_permission_type[19]->display_type == 1){ ?>
								<td id="19_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->order_site_levels;  ?>
								</td>
								<?php } if($nuser_permission_type[20]->display_type == 1){ ?>
								<td id="20_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->order_soil_report;  ?>
								</td>
								<?php } if($nuser_permission_type[21]->display_type == 1){ ?>
								<td id="21_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->septic_tank_approval;  ?>
								</td>
								<?php } if($nuser_permission_type[70]->display_type == 1){ ?>
								<td id="70_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->drainage_testing;  ?>
								</td>
								<?php } if($nuser_permission_type[22]->display_type == 1){ ?>
								<td id="22_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->dev_approval;  ?>
								</td>
								<?php } if($nuser_permission_type[32]->display_type == 1){ ?>
								<td id="32_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->landscape;  ?>
								</td>
								<?php } if($nuser_permission_type[33]->display_type == 1){ ?>
								<td id="33_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->mss;  ?>
								</td>
								<?php } if($nuser_permission_type[23]->display_type == 1){ ?>
								<td id="23_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->project_manager;  ?>
								</td>
								<?php } if($nuser_permission_type[25]->display_type == 1){ ?>
								<td id="25_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
								...
								<?php } if($nuser_permission_type[26]->display_type == 1){ ?>
								<td id="26_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php if($consent_child[$c]->handover_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->handover_date); }  ?>
								</td>
								<?php } if($nuser_permission_type[27]->display_type == 1){ ?>
								<td id="27_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->builder;  ?>
								</td>
								<?php } if($nuser_permission_type[67]->display_type == 1){ ?>
								<td id="67_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
									<?php echo $consent_child[$c]->for_sale_sign;  ?>
								</td>
								<?php } if($nuser_permission_type[68]->display_type == 1){ ?>
								<td id="68_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;">
								...
								?>
								<td id="34_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_title_date; ?>">
									<?php if($consent_child[$c]->title_date!='0000-00-00'){ echo $this->wbs_helper->to_report_date($consent_child[$c]->title_date); } ?>
								</td>
								<?php } if($nuser_permission_type[35]->display_type == 1){ ?>
								<td id="35_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php if($consent_child[$c]->settlement_date != '0'){ ?> background-color:orange; color:black; <?php } ?>">
								<?php
									if($consent_child[$c]->title_date != '0000-00-00'){ 
								...
								?>
								<td id="69_col_<?php echo $consent_child[$c]->job_no; ?>" class="child close" style="width:145px;height:45px;<?php echo $bg_photos_taken; ?>">
									<?php 
