...
Class Wbs_helper{
    ...
    // Consent system date format 'dd-mm-yy' to mysql format 'yyyy-mm-dd'
    function change_cms_date($cms_date){
		$filed_values = str_replace("-","/",$cms_date);
		$dates = explode("/",$filed_values);
		$filed_values = $dates[1].'/'.$dates[0].'/'.'20'.$dates[2];
		return date("Y-m-d", strtotime($filed_values));
	}
