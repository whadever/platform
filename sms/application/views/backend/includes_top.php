...
<link rel="stylesheet" href="<?php echo base_url(); ?>js/fullcalendar/fullcalendar.print.css" media="print">

<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/custom.css">

<?php
    $skin_colour = $this->db->get_where('sms_settings' , array(
        'type' => 'skin_colour'
    ))->row()->description; 
    if ($skin_colour != ''):?>
...
<link rel="stylesheet" href="<?php echo base_url();?>css/style_custom.css">
