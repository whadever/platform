            ...
            <div class="tab-pane box active" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    	...
                    	$books = $this->db->get('sms_book')->result_array();
                    	$count = 1;
                        ...
                        <tr>
							...
							<td><a href="<?php echo base_url();?>admin/book/change_status/<?php echo $row['book_id'];?>/<?php  echo $row['status']=='available'?'unavailable':'available';?>"><span class="label label-<?php if($row['status']=='available')echo 'success';else echo 'secondary';?>"><?php echo $row['status'];?></span></a></td>
							<td>
                            <div class="btn-group">
