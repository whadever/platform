...
class Login extends CI_Controller {
    ...
    public function index() {
        if ($this->session->userdata('user')){
        	...
        	$app_role = $this->db->get_where('users_application', array('user_id'=>$user->uid, 'application_id'=>'10'))->row();
        	$this->session->set_userdata('login_user_id', $user->uid);
        	if($app_role->application_role_id=='1'){
