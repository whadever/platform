...
<div class="bread_crumb_box" style="background-color:#f5f5f5; width:100%; height:50px;">
	<div class="bread_crumb_part" style="float:left">
		<?php
    ...
    <?php if($project->created_by == $user->uid){?>   

    <div class="settings_part" style="float:right;padding:7px">
		<a href="#"><img class="settings" src="<?php echo base_url() ?>images/icon/settings.png" /></a>
	</div>

	<div class="user_box" style="background-color:#f5f5f5;display:none;margin:50px 17px 0px 0px;position:absolute;right:0;width:300px;z-index:10000;padding:10px">
	
		<h4>Set Privacy</h4>
		
		<table>
			<tr>
				<td>All </td><td><input type="radio" name="privacy" value="0" <?php if($project->privacy_type == 0){ ?> checked <?php } ?>></td>
			</tr>
			<tr>
				<td>Shared with Managers</td><td> <input type="radio" name="privacy" value="1" <?php if($project->privacy_type == 1){ ?> checked <?php } ?>></td>
			</tr>
			<tr>
				<td>Only Me</td><td> <input type="radio" name="privacy" value="2" <?php if($project->privacy_type == 2){ ?> checked <?php } ?>></td>
			</tr>
			<tr>
				<td>Custom</td><td> <input id="Assigned Managers" type="radio" name="privacy" value="3" <?php if($project->privacy_type == 3){ ?> checked <?php } ?>></td>
			</tr>
			<tr id="user_list" <?php if($project->privacy_type != 3){ ?> style="display:none" <?php } ?>>
				<td colspan="2"><?php echo $assign_user; ?></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
    ...
    $(document).ready(function() {
        ...
        $("input[name=privacy]").click(function(){
            var privacy_type = $("input[name=privacy]:checked").val();
            var url = encodeURI(site_url+"project/update_project_privacy/"+<?php echo $project_id; ?>+"/"+privacy_type);
            $.ajax(url,{
        ...
        $("#assign_user_select").change(function () {
            var cid = $(this).val();
            jQuery.ajax({
                url: "<?php echo base_url(); ?>" + "project/update_privacy_user_ids?project_id=" + <?php echo $project_id; ?> + "&cid=" + encodeURIComponent(cid),
                type: 'GET',
                success: function(data) 
                {
                },
...
<div id="project-detail" class="content-inner">
    ...
    <div class="box"> 
        <div class="row">
            ...
            <div id="button_wrapper" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 button-wrapper">
                    ...
                    <div class="col-md-12">    
                        <p><a class="btn btn-default" data-toggle="modal" data-target="#projectCloseModal" >Complete Project</a></p>
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
            ...
            <a href="#" id="pirnt_open_tasks" style="position: absolute; right: 20px; top: 11px;">
                <img src="<?php echo base_url()?>images/print.png" class="hidden-xs hidden-sm"/>
            </a>
            <div class="scroll">
       ...
       <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
           <h4 align="center">Completed Tasks(<?php if(isset($count_close_bug)) { echo $count_close_bug;} ?>)</h4>
           <div class="scroll">
    ...
    <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="project_image_box">
                    <?php echo $project->image==''? 'No Image':'<a class="fancybox" href="'.base_url().'uploads/request/document/'.$project->image.'"><img width="100%" src="'.base_url().'uploads/request/document/'.$project->image.'" title="'.$project->image.'" alt="'.$project->image.'"/></a>'; ?>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="projectCloseModalLabel">Complete Project</h4>
      </div>
      <div class="modal-body">
...
<script>
    ...
    $( document ).ready(function () {
		...
		/* fix header table */
		$('#project_open_bug_table').fixedHeaderTable({ 
			footer: true, altClass: 'odd'
		});

		$('#project_close_bug_table').fixedHeaderTable({ 
			footer: true, altClass: 'odd'
		});
