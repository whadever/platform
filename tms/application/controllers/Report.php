...
class Report extends CI_Controller {
	...
	public function report_list_new() {	           
            ...
            $data['title'] = 'Reports';
            $data['maincontent'] = $this->load->view('report/report_new',$data,true);
	...
	function print_report(){
		...
		$data['maincontent'] = $this->load->view('report/print_report',$data,true);
		$this->load->view('home',$data);
	}

	public function report_project() {	               
		
		$data['title'] = 'Monthly Project Reports';
		$data['maincontent'] = $this->load->view('report/report_project',$data,true);
