...
class Notes extends CI_Controller
{
    ...
    public function show_notes($rid, $notify_user_id = '')
    {
        ...
        $message .= "<tr><td><strong>Request Id :</strong> </td><td>" . $request_no . "</td></tr>";
        $message .= "<tr><td><strong>Request Title:</strong> </td><td>" . $request_title . "</td></tr>";
        $message .= "<tr><td><strong>Task Notes:</strong> </td><td>" . $note_body . "</td></tr>";
        $message .= "<tr><td><strong>Project Name:</strong> </td><td>" . $request_project . "</td></tr>";
        if(!empty($notify_user_name)){

            $message .= "<tr><td><strong>Notified:</strong> </td><td>" . implode(", ",$notify_user_name) . "</td></tr>";
            //$headers .= "X-notified:" . implode(", ",$notify_user_name) . "\r\n";
        }

        $message .= "<tr><td><strong>Notes From :</strong> </td><td>" . $notes_from . "</td></tr>";

        $message .= "<tr><td><strong>URL :</strong> </td><td>" . site_url("notes/index/" . $request_no) .  "</td></tr>";
