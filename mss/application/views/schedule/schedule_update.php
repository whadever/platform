...
<div class="content">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			...
			<form method="POST" action="<?php echo base_url(); ?>schedule/schedule_update/<?php echo $schedule->id; ?>">
		                  	...
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input required="" class="form-control" type="text" name="schedule_name" id="schedule_name" value="<?php echo $schedule->schedule_name; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<select required="" name="client_id" class="form-control">
											...
											{
											?>
											<option <?php if($schedule->client_id==$row->id){ echo 'selected=""'; } ?> value="<?php echo $row->id; ?>"><?php echo $row->client_name; ?></option>
											<?php
											}
											?>
										</select>
		                  		...
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input required="" class="form-control" type="text" name="legal_description" id="legal_description" value="<?php echo $schedule->legal_description; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input required="" class="form-control" type="text" name="property_address" id="property_address" value="<?php echo $schedule->property_address; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  	...
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input class="form-control" type="text" name="designer_phone_number" id="designer_phone_number" value="<?php echo $schedule->designer_phone_number; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="designer_email_address">Email Address</label>
		                  				<input class="form-control" type="text" name="designer_email_address" id="designer_email_address" value="<?php echo $schedule->designer_email_address; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="designer_website">Website</label>
		                  				<input class="form-control" type="text" name="designer_website" id="designer_website" value="<?php echo $schedule->designer_website; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  </div>
		                  	...
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input class="form-control" type="text" name="duilder_name" id="duilder_name" value="<?php echo $schedule->duilder_name; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="duilder_address">Address</label>
		                  				<input class="form-control" type="text" name="duilder_address" id="duilder_address" value="<?php echo $schedule->duilder_address; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="duilder_phone_number">Phone Number</label>
		                  				<input class="form-control" type="text" name="duilder_phone_number" id="duilder_phone_number" value="<?php echo $schedule->duilder_phone_number; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input class="form-control" type="text" name="duilder_email_address" id="duilder_email_address" value="<?php echo $schedule->duilder_email_address; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="duilder_website">Website</label>
		                  				<input class="form-control" type="text" name="duilder_website" id="duilder_website" value="<?php echo $schedule->duilder_website; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  </div>
		                  	...
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input class="form-control" type="text" name="licenced_building_practitioner" id="licenced_building_practitioner" value="<?php echo $schedule->licenced_building_practitioner; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="licence_class">Licence Class</label>
		                  				<input class="form-control" type="text" name="licence_class" id="licence_class" value="<?php echo $schedule->licence_class; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="licence_number">Licence Number</label>
		                  				<input class="form-control" type="text" name="licence_number" id="licence_number" value="<?php echo $schedule->licence_number; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  	<div class="row">
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				...
		                  				<input class="form-control" type="text" name="licenced_building_practitioner1" id="licenced_building_practitioner1" value="<?php echo $schedule->licenced_building_practitioner1; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="licence_class1">Licence Class</label>
		                  				<input class="form-control" type="text" name="licence_class1" id="licence_class1" value="<?php echo $schedule->licence_class1; ?>" />
		                  			</div>
		                  		</div>
		                  		<div class="col-xs-12 col-sm-12 col-md-4">
		                  			<div class="form-group">
		                  				<label for="licence_number1">Licence Number</label>
		                  				<input class="form-control" type="text" name="licence_number1" id="licence_number1" value="<?php echo $schedule->licence_number1; ?>" />
		                  			</div>
		                  		</div>
		                  	</div>
		                  </div>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 template">
						<div class="form-group">
							...
							<select class="form-control" name="template_id" id="template_id">
								...
								{
								?>
								<option <?php if($schedule->template_id==$row->id){ echo 'selected=""'; } ?> value="<?php echo $row->id; ?>"><?php echo $row->template_name; ?></option>
								<?php
								}
								?>
							</select>
						...
						<div class="table-responsive product_table_drop">
							<table id="product_table" class="table">
								...
								<tbody>
									...
									$this->db->select('schedule_template_product.*');
									//$this->db->where('template_id',$template_id);
									$this->db->where('schedule_id',$schedule_id);
									$this->db->order_by('ordering','ASC');
									$schedule_products = $this->db->get('schedule_template_product')->result();
									//print($templates);
									foreach($schedule_products as $schedule_product)
									{
										$product_id = $schedule_product->product_id;
				...
				<div class="row submit-button">
					...
					<div class="col-xs-12 col-sm-12 col-md-2 submit">
						<input class="form-submit btn btn-info" type="submit" name="submit" value="Edit Schedule" />
					</div>
				</div>
