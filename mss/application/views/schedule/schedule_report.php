...
<div class="container-fluid">
	<div class="report schedule-report">
		...
		<div class="report-body">
			...
			<div class="row">
				<div class="col-xs-12">
					<h2><?php echo $report->schedule_name; ?></h2>
					<h4>Overview</h4>
					...
					<table class="table">
						<tbody>
							<tr>
								<td colspan="2">Schedule Details</td>
							</tr>
							<tr>
								<td>Client Name</td><td><?php echo $report->client_name; ?></td>
							</tr>
							<tr>
								<td>Property Address</td><td><?php echo $report->number.' '.$report->street.' '.$report->suburb.' '.$report->city; ?></td>
							</tr>
							<tr>
								<td>Legal Description</td><td><?php echo $report->legal_description; ?></td>
							</tr>
							
							<tr>
								<td>Code of compliance Certificate</td><td><?php echo 'Yes / No'; ?></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						<tbody>
							<tr>
								<td colspan="2">Architect/Builder Details</td>
							</tr>
							<tr>
								<td>Company Name</td><td><?php echo $report->designer_company_name; ?></td>
							</tr>
							<tr>
								<td>Phone number</td><td><?php echo $report->designer_phone_number; ?></td>
							</tr>
							<tr>
								<td>Email address</td><td><?php echo $report->designer_email_address; ?></td>
							</tr>
						</tbody>
					</table>
		...
		<div class="report-body">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					$reports = $ci->Schedule_model->product_report($tem_id)->result();

					foreach($reports as $report){ 

					$file = $report->filename==''? 'No document': '<a target="_bank" href="'.base_url().'uploads/document/'.$report->filename.'">'.$report->filename.'</a>';
