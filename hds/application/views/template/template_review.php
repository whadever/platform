				...
				<div class="review">
					...
					<div class="review-content">
						...
						?>
							...
							<div class="review-content sub-task">
								<?php
								$task_id = $task_row->id;
							...
							?>
								...
								<a href="#EditSubTask_<?php echo $sub_task_row->id; ?>" title="Task Edit" role="button" data-toggle="modal">
								...
								<form class="form-horizontal" action="<?php echo base_url(); ?>template/template_task_update/<?php echo $sub_task_row->id; ?>" method="POST">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
