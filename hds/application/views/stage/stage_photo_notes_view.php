...
?>
  ...
  <script> 
	...
	$("#submitnote").click(function (e) {
        ...
        $.ajax({  
        url:"<?php echo base_url();?>stage/insert_photo_notes/"+rid+"/"+userid,  
        dataType: 'html',
		data: { notes: myval },  
        type: 'GET',   
...
window.onload=function(){
    var rid = $('#request_id').val();
    $.ajax({  
        url:"<?php echo base_url();?>stage/show_photo_notes_with_image/"+rid,  
        dataType: 'html',  
        type: 'GET',   
        success:function(data){						  
                         if(data){  	                    
...
function notesDelete(noteid){
    ...
    if (r == true) {
        $.ajax({  
            url:"<?php echo base_url();?>stage/photo_notes_delete/"+pid+"/"+noteid,  
            dataType: 'html',  
            type: 'GET',   
            success:function(data){						  
                if(data){  
