...
<?php
	...
	$query =$this->db->query("SELECT * FROM users_application where user_id=$user->uid and application_id=1");
	$row = $query->row();
	$user_role_id = $row->application_role_id;

	
	$url = 'developments/developments_list_overview';
...
<div id="front-page" style="text-align:center;">
	<div id="divCircle">
		<div class="image-box1"><a style="text-decoration:none; color:black" href="<?php echo base_url().''.$url; ?>"><img width="110px" src="<?php echo base_url();?>/images/pms_home.png" /> <p>Current Development</p></a></div>
		<?php if($user_role_id == 3){ ?>
		<div class="image-box1"><a style="text-decoration:none; color:black" href="<?php echo base_url(); ?>report/contractor_report/<?php echo $user->uid; ?>"> <img width="110px" src="<?php echo base_url();?>/images/home_report.png" /> <p>Reports</p></a></div>
		<!---<div class="image-box1"><a style="text-decoration:none; color:black" href="#"><img width="110px" src="<?php echo base_url();?>/images/home_potential_land.png" /><p>Potential Land</p></a></div>--->
		<?php }elseif($user_role_id == 2){ ?>
		<div class="image-box1"><a style="text-decoration:none; color:black" href="<?php echo base_url(); ?>report"> <img width="110px" src="<?php echo base_url();?>/images/home_report.png" /> <p>Reports</p></a></div>
		
		<div class="image-box1"><a style="text-decoration:none; color:black" href="<?php echo base_url(); ?>potential_developments/developments_list_overview"><img width="110px" src="<?php echo base_url();?>/images/home_potential_land.png" /><p>Potential Land</p></a></div>
