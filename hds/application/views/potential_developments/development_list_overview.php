...
jQuery(document).ready(function() {
	...
	$("#development-name").keyup(function() {
		...
		$.ajax({
			url: window.Url + 'potential_developments/change_development_status/' + selectedStatusId,
			type: 'GET',
...
<script>
	...
	{ 		 
		...
		$.ajax({  
        	url:window.Url +"potential_developments/show_developments_featured_photo/"+did,  
        	dataType: 'html',  
        	type: 'GET',   
        	success:function(data){						  
	            if(data){  	                    
	            	...
	            	console.log(data); 	
					$('.dev-main-table-inner-right').empty();
					$('.dev-main-table-inner-right').append(data);
		...
		//url: window.Url + 'developments/change_development_status/' + selectedStatusId,
...
<?php 
	...
	$logo = 'http://'.$_SERVER['SERVER_NAME'].'/uploads/logo/'.$wpdata->filename;
...
.dev-main-inner, .dev-main-button {
				...
				<div class="dev-main-inner">
					...
					<div class="dev-main-body">
						...
						<div class="dev-main-table">
							<div class="dev-main-table-inner" style="float:left;width:50%">
								<table>
									<tbody>
									<?php
										...
										{
									?>
											<tr id="check_<?php echo $development->id; ?>" onclick="<?php echo 'setdevelopmentid('. $development->id . ');'; ?>"><td><span><?php echo $development->development_name; ?></span><a style="display: none;" href="development_detail/<?php echo $development->id; ?>"><?php echo $development->development_name; ?></a></td></tr>
									<?php 
										}
									?>
									</tbody>
							...
							<div class="dev-main-table-inner-right" style="float:left; width:50%;text-align:center;">								
							</div>
							<div class="clear"></div>
						</div>
					</div>
