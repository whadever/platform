...
<div id="development-notes">
    ...
    <div id="add-note-dialog-box" title="">
        ...
        <form id="addnoteform" action="<?php echo base_url();?>potential_developments/save_development_note/<?php echo $note_development_id;?>" method="post">
    ...
    <div id="note-message-dialog-box" title="">    
        ...
        <form id="addmessageform" action="<?php echo base_url();?>potential_developments/send_development_note_message/<?php echo $note_development_id;?>" method="post">
...
<script>
    function loadNotes(note_id){
        ...
        $.ajax({  
                url: "<?php print base_url(); ?>potential_developments/development_notes_details/"+note_id,  
                dataType: 'html',  
                type: 'GET',  
...
<script type="text/javascript">
 ...
 function email_this_notes(){
	 ...
	 $.ajax({
         url: "<?php print base_url(); ?>potential_developments/email_development_notes/"+note_id,  
             dataType: 'html',  
             type: 'GET',                
             success:     
             function(data){               
