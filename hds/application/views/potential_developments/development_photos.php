...
<section class="slider">
    ...
    <div class="button-box" style="padding:0px; margin:10px 2px 5px 2px;float: left;">                  	
		...
		<a id="photo-archive" class="btn_dev_info"  href="<?php echo base_url();?>potential_developments/development_archive_photos/<?php echo $development_id;?>">
			<img width="60" alt="Photo Archive"  title="Photo Archive" src="<?php echo base_url();?>images/archive.png">
		</a>
...
$(document).ready(function () {
	...
	$("#photo-notes").click(function () {
			...
			if(photo_id == null){
				...
				window.location = window.wbsBaseUrl+"potential_developments/photo_notes/"+photo_id+"/"+<?php echo $development_id?>;
			}
	});	 
	...
	$("#save-development").click(
		function () {
			...
			if(photo_id1 == null){
				...
				window.location = window.wbsBaseUrl+"potential_developments/pdf_developments_photo/"+photo_id1;
			}
		}
    );
    $("#print-development").click(
		function () {
			...
			if(photo_id1 == null){
				...
				window.open(window.wbsBaseUrl+'potential_developments/print_developments_photo/'+photo_id1, '_blank', 'width=800,height=600,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');
			}
		}
    );
   ...
   $("#email-development").click(
		function () {
			...
			$.ajax({
            url: "<?php print base_url(); ?>potential_developments/email_outlook_development/"+photo_id1,  
                dataType: 'html',  
                type: 'POST',  
	...
	$(".feature_photo").click(function () {
					...
					$.ajax({
		            	url: "<?php print base_url(); ?>potential_developments/photo_action_featured/"+photo_id+"/"+checked,  
		                dataType: 'html',  
		                type: 'POST', 		                 
		                success:     
		                function(data){ 							 
		...
		$(".private_photo").click(function () {
					...
					$.ajax({
		            	url: "<?php print base_url(); ?>potential_developments/photo_action_private/"+photo_id+"/"+checked,  
		                dataType: 'html',  
		                type: 'POST', 		                 
		                success:     
		                function(data){ 							 
	...
	<div id="photo-message-dialog-box" title="">    
        ...
        <form id="addmessageform" action="<?php echo base_url();?>potential_developments/send_development_photo_message" method="post">
...
<div id="delete-photo-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		<form action="<?php echo base_url();?>potential_developments/development_photo_delete" method="post">
...
<div id="dialog" title="">
        ...
        <div id='imagebox' style="width:250px; height:300px; border: 1px solid;float: left;"> 
            ...
            <form id="uploadform" action="<?php echo base_url();?>potential_developments/upload_development_photo/<?php echo $development_id;?>" method="post" enctype="multipart/form-data" >
        ...
        <div style="float:left;width:200px; height: 300px;margin-left: 10px;">
                <form id="photoinfoform" action="<?php echo base_url();?>potential_developments/save_development_photo/<?php echo $development_id;?>" method="post">
...
<script>
    ...
    function email_dev_photo(photo_name){
        ...
        $.ajax({
            url: "<?php print base_url(); ?>potential_developments/email_dev_photo/"+photo_name,  
                dataType: 'html',  
                type: 'GET',  
