...
<div class="archive-right">
	<div class="archive-right-inner">
		<a href="<?php echo base_url(); ?>potential_developments/development_photos/<?php echo $development_id;?>"><img width="25" alt="Back"  title="Back" src="<?php echo base_url();?>images/archive_back.png">Back</a>
	</div>
</div>
...
<div id="delete-photo-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		<form action="<?php echo base_url();?>potential_developments/development_archive_photo_delete" method="post">
