	...
	if (jQuery("#sortable-task-<?php echo $phase_row->id; ?>").length){
		...
		$( "#sortable-task-<?php echo $phase_row->id; ?>" ).disableSelection();
						...
						<?php
							...
							$task_query = $this->db->query("SELECT * FROM development_task where template_id=$template_id and development_id=$development_id and phase_id=$phase_id ORDER BY ordering ASC");
