...
<div class="clear"></div>
	...
	<div class="template-footer">
			...
			<?php if(!isset($template_review_update->id)) : ?>
			<a class="next" href="<?php echo base_url();?>potential_template/template_list">Finish</a>
			<?php else : ?>
			<a class="next" href="<?php echo base_url();?>potential_template/template_detail/<?php echo $template_id; ?>">Finish</a>
			<?php endif; ?>
		<div class="clear"></div>
	</div>
<div class="clear"></div>
