...
<div class="template-review template-detail" style="background: #fff;">
	<div class="template-header">
			...
			$template_row_query = $this->db->query("SELECT * FROM potential_template where id=$template_id");
	...
	<div class="template-body">
		<div class="review-body">
			...
			<?php 
				...
				$query = $this->db->query("SELECT * FROM potential_template_phase where template_id=$template_id ORDER BY ordering ASC");
			...
			?>
				<div class="review">
					...
					<div class="review-content">
						<?php 
							$phase_id = $phase->id;
							$query1 = $this->db->query("SELECT * FROM potential_template_task where template_id=$template_id and phase_id=$phase_id ORDER BY ordering ASC");
