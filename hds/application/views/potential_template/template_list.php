			...
			<table class="table-hover">
				...
				<?php foreach ($templates as $template){ ?>
					<tr class="check" onclick="<?php echo 'setprojectid('. $template->id . ');'; ?>">
						...
						<td>
						<?php 
						$phase_query = $this->db->query("SELECT * FROM potential_template_phase where template_id=".$template->id);
						...
						<td>
						<?php 
						$task_query = $this->db->query("SELECT * FROM potential_template_task where template_id=".$template->id);
