		...
		<div class="document-left-bottom">
			<div class="document-table">
				...
				<!-- MODAL Phase Delete-->
					...
					<form class="form-horizontal" action="<?php echo base_url();?>developments/development_document_update/<?php echo $document->id; ?>" method="POST">
...
<script type="text/javascript">
	...
	$(function() 
	{
		...
		$query = $this->db->query("SELECT * FROM development_documents where development_id=$development_id order by filename_custom ASC");
