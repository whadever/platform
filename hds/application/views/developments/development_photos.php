...
<section class="slider">
    ...
    <div class="button-box" style="padding:0px; margin:10px 2px 5px 2px;float: left;">                  	
		...
		<a id="photo-archive" class="btn_dev_info"  href="<?php echo base_url();?>developments/development_archive_photos/<?php echo $development_id;?>">
...
<div id="delete-photo-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		<form action="<?php echo base_url();?>developments/development_photo_delete" method="post">
