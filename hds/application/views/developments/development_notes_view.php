...
?> 
  <script> 
	...
	$("#submitnote").click(function (e) {
        ...
        $.ajax({  
        url:"<?php echo base_url();?>developments/show_notes/"+rid,  
        dataType: 'html',
		data: { userid: encodeURIComponent(userid), notes: note_param6, private: private },  
        type: 'GET',   
...
window.onload=function(){
    var rid = $('#request_id').val();
    $.ajax({  
        url:"<?php echo base_url();?>developments/show_notes_with_image/"+rid,  
        dataType: 'html',  
        type: 'GET',   
        success:function(data){						  
                         if(data){  	                    
...
function notesDelete(noteid){
    ...
    if (r == true) {
        $.ajax({  
            url:"<?php echo base_url();?>developments/notes_delete/"+pid+"/"+noteid,  
            dataType: 'html',  
            type: 'GET',   
            success:function(data){						  
                if(data){  
