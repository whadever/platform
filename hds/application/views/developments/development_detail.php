        ...
        <div class="development-detail">
            <div id="development-detail-left">
                ...
                <div class="button-box" style="padding:0px; margin:0px;">
                    ...
                    echo anchor_popup(base_url().'developments/print_development/'.$development_id, img($print_developments_img), $atts);                    
                    echo anchor(base_url().'developments/pdf_developments/'.$development_id, img($save_developments_img), array('title' => 'Save Developments Info', 'class'=> 'btn_dev_info'));
...
<div id="milestone_overview">
	...
	<?php 
		...
		for($i=0; $i<count($stage_milestone_details); $i++){
			...
			$stage = $ci->stage_model->get_stage_detail($development_id, $stage_milestone_details[$i]->stage_no)->row();
...
<div id="UpdateDevelopment" class="modal stage hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>developments/development_update/<?php echo $development_details->id; ?>" method="POST">
