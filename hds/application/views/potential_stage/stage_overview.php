...
foreach($phase_info as $phase)
{
	...
	$graph_start_date[] = $phase->planned_start_date;
	$graph_end_date[] = $phase->planned_finished_date;
	...
	if( $phase->planned_start_date > '0000-00-00')
	{
		...
		{
			$created_date = date_create($phase->planned_start_date);
			$str = '21 days';
...
<style>
#stage-overview{	
	/*	float:left; width:73%; margin-right:2%; */
}
...
FusionCharts.ready(function () {
    ...
    "tasks": {
        "task": [
			...
			$phase_end_date_time = strtotime($planned_finished_date);
			...
			else
			{
				...
				echo '{ "start": "'.date("m/d/Y", strtotime($phase->planned_start_date)).'",'; 
