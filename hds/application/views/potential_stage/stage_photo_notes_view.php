...
?>
  ...
  <script> 
	...
	$("#submitnote").click(function (e) {
        ...
        $.ajax({  
        url:"<?php echo base_url();?>potential_stage/insert_photo_notes/"+rid+"/"+userid,  
        dataType: 'html',
		data: { notes: myval },  
        type: 'GET',   
...
window.onload=function(){
    var rid = $('#request_id').val();
    $.ajax({  
        url:"<?php echo base_url();?>potential_stage/show_photo_notes_with_image/"+rid,  
        dataType: 'html',  
        type: 'GET',   
        success:function(data){						  
                         if(data){  	                    
...
function notesDelete(noteid){
    ...
    if (r == true) {
        $.ajax({  
            url:"<?php echo base_url();?>potential_stage/photo_notes_delete/"+pid+"/"+noteid,  
            dataType: 'html',  
            type: 'GET',   
            success:function(data){						  
                if(data){  
...
<div id="note_page" style="background:none;width:100%;">
        ...
        <div style="background:#002855; text-align: center; color: #fff; font-size:20px; padding:5px;border-radius:5px;"> 
            Stage Photo Notes</div>
  <div class="row1"> 
<div class="notes_box" style="width:50%; float:left;"> 
<p>&nbsp;</p>
<img width="450px" src="<?php echo base_url(); ?>uploads/stage/<?php echo $photo->filename; ?>" /> 
</div>
<div class="notes_box" style="width:50%; float:left;"> 
