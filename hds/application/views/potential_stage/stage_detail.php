                ...
                <div class="button-box" style="padding:0px; margin:0px;">
                	...
                	//echo anchor(base_url().'stage/stage_documents/'.$development_id.'/'.$stage_id, img($stage_documents_img), array('title' => 'Stage Documents', 'class'=> 'btn_dev_info'));
                  	...
                  	if(isset($stage_detail->id)){
						...
						echo anchor_popup(base_url().'potential_stage/stage_print/'.$stage_id_new, img($print_stage_img), $atts);                    
                    	echo anchor(base_url().'potential_stage/pdf_stage/'.$stage_id_new, img($save_stage_img), array('title' => 'Save Stage Info', 'class'=> 'btn_dev_info'));
					}else{
					?>
...
<form class="form-horizontal" action="<?php echo base_url(); ?>potential_stage/update_milestone/<?php echo $development_id.'/'.$stage_no; ?>" method="POST">
...
<form class="form-horizontal" action="<?php echo base_url(); ?>potential_stage/add_new_milestone" method="POST">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="AddStage_<?php echo $stage_no; ?>" class="modal stage hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>potential_stage/<?php if(isset($stage_detail->id)){ echo 'stage_update/'.$stage_detail->id;} else { echo 'stage_add';}?>" method="POST">
		<div class="modal-header">
