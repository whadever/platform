...
class Admindevelopment extends CI_Controller {
	...
	public function development_task_add($parent_task_id='0') {        
        ...
        if ( $this->input->post('submit')) {
			...
			redirect('admindevelopment/'.$url.'/'.$development_id.'/'.$template_id.'/'.$phase_id.'/'.$parent_task_id);
			
		} 
		
	}
	
	public function development_task_update($task_id,$parent_task_id='0') {        
	...
	public function development_task_delete($task_id,$parent_task_id='0'){
	...
	public function stage_task_add($parent_task_id='0') {        
        ...
        if ( $this->input->post('submit')) {
			...
			redirect('admindevelopment/'.$url.'/'.$development_id.'/'.$stage_no.'/'.$phase_id.'/'.$parent_task_id);
