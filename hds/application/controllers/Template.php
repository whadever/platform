...
class Template extends CI_Controller {
	...
	public function template_basic_info() { 
        ...
        $no_sub_tasks = $post['no_sub_tasks'];
         if ( $this->input->post('submit')) {
		    ...
		    $this->template_model->save_phase_and_task($id,$no_phases,$no_tasks,$no_sub_tasks);
	...
	public function template_task_add($parent_task_id='0') {        
        ...
        if ( $this->input->post('submit')) {
			...
			redirect('template/'.$url.'/'.$template_id.'/'.$phase_id.'/'.$parent_task_id);
			
		} 
		
	}
	
	public function template_task_update($task_id,$parent_task_id='0') {        
	...
	public function template_task_delete($task_id,$parent_task_id='0'){
	...
	public function template_sub_task_ordering(){
    	$this->template_model->template_sub_task_ordering();
    }
