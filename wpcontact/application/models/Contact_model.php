...
class Contact_model extends CI_Model {
	...
	function contact_list_delete($id){
		$this->db->where($this->primary_key,$id);
		$this->db->delete($this->table_contact);	
	}
	...
	function get_contact_list($contact_name, $sort_by = 'id', $order_by = 'desc',$offset=0,$limit=10,$get = NULL)
	{
	...
	function get_contact_details($contact_id){
		$this->db->select('contact_contact_list.*, contact_file.filename,contact_company.company_name');
