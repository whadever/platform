...
{   
	...
	$("#contact_list_view table tr").each(function()
	{
		...
		var contact_no = $(this).find("td").eq(4).text().replace(/\s+/g,'');
		...
		<div class="row"> 
			<div class="col-xs-12 col-sm-6 col-md-6">
            	<div class="contactsearchbox">
					<input type="text" class="search_contact" id="search_contact" name="search" placeholder="Search" />
				</div>
     		</div>
			<div class="col-xs-12 col-sm-6 col-md-6">
				<span style="float:right;padding-left: 10px;"><a href="<?php echo base_url().'contact/add_bulk_contact'; ?>">Add bulk Contact <img src="<?php echo base_url() ?>images/icons/icon_add_company.png" width="40"/></a> </span>
                                
				<span style="float:right;"><a href="<?php echo base_url(); ?>contact/contact_add">Add Contact <img src="<?php echo base_url() ?>images/icons/icon_add_contact.png" width="40" /></a> </span>  
				
				<span style="float:right;margin-right: 10px;">
                    	<a class="btn btn-default" href="<?php echo base_url().'contact/contact_export_to_excel'; ?>">
                    		EXCEL </a> </span>   
			</div>
		</div>
	</div>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php if($application_role == 1){ ?><a href="<?php echo base_url() ?>contact/contact_add/<?php echo $contact->id; ?>"><img class="edit_icon" src="<?php echo base_url(); ?>images/icons/icon_edit.png" /></a><a onclick="return confirm('Are you sure want to delete this Contact?');" href="<?php echo base_url() ?>contact/contact_list_delete/<?php echo $contact->id; ?>"><img class="edit_icon" style="margin-right:5px;" src="<?php echo base_url(); ?>images/delete_icon.png" /></a><?php } ?></td>
