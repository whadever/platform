			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php if($contact->status == 1){ echo "ACTIVE";}else{echo "INACTIVE";} ?><?php if($application_role == 1){ ?><a href="<?php echo base_url() ?>contact/contact_add/<?php echo $contact->id; ?>"><img class="edit_icon" src="<?php echo base_url(); ?>images/icons/icon_edit.png" /></a><?php } ?></td>
						<td style="display:none;"><?php echo $contact->contact_website; ?></td>
