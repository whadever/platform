<?php
	...
	$category_options = array('' => '--Select Category--') + $cat_options;
	$company_js = 'class="form-control"';
	...
	$project_company .= form_dropdown('company_id', $company_options, '', $company_js);
...
<?php          
	...
	$this->breadcrumbs->push('Add Bulk Contact', 'contact/contact_add/');
?>
...
<div class="contact_add_bulk">
    ...
    <div class="row">
		...
		<div class="col-xs-12 col-sm-4 col-md-3">
	       	<a href="<?php echo base_url(); ?>uploads/excel/blank_contact_excel_file.xlsx" target="_blank" class="btn btn-info btn-sm">
