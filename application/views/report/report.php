			...
			<div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
				 <div class="dropdown">
					  ...
					  <ul class="dropdown-menu" style="width:100%;">
						...
						<li><a href="<?php echo base_url(); ?>report/export_client_list">Export Client List</a></li>
					  </ul>
				</div>
			</div>
		</div>
				...
				?>
					<table class="table">
						...
						<tr>
							...
							<td><?php echo $client->person_in_charge; ?></td>
						</tr>
						<tr>
							<td>Phone number:</td>
			...
			<div class="col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
				...
				?>
					<table class="table">
						...
						<tr>
							<td>Full/Discounted Price:</td>
							<td><?php echo $client->pricing?'Discounted Price':'Full Price'; ?></td>
						</tr>
						<tr>
							<td>System(s):</td>
							<td><?php 
								$applications = $CI->report_model->applications($client->company_id)->result();
								foreach($applications as $application){
									echo $application->application_name.'<br/>';
								}
